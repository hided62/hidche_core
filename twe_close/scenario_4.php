...
//////////////////////////국가1/////////////////////////////////////////////////
RegNation($connect, "조조", "000080", 10000, 10000, "황제를 등에 업고 본격적으로 성장하는 조조", 1000, 37, "병가", 4);
//////////////////////////국가2/////////////////////////////////////////////////
RegNation($connect, "원소", "FFFF00", 10000, 10000, "공손찬과 일전을 준비하는 원소", 1000, 29, "법가", 4);
//////////////////////////국가3/////////////////////////////////////////////////
RegNation($connect, "손책", "FF0000", 10000, 10000, "강동에서 세력을 떨치는 소패왕 손책", 1000, 22, "병가", 3);
//////////////////////////국가4/////////////////////////////////////////////////
RegNation($connect, "유표", "E0FFFF", 10000, 10000, "형주에서 기반을 넓히는 강하팔준 형주자사 유표", 1000, 22, "유가", 4);
//////////////////////////국가5/////////////////////////////////////////////////
RegNation($connect, "유장", "483D8B", 10000, 10000, "익주에서 세력을 굳히는 유언의 후계 유장", 1000, 19, "유가", 4);
//////////////////////////국가6/////////////////////////////////////////////////
RegNation($connect, "원술", "FFC0CB", 10000, 10000, "회남지방에서 황제를 노리는 원술", 1000, 12, "도가", 7);
//////////////////////////국가7////////////////////////////////////////////////
RegNation($connect, "유비", "008000", 10000, 10000, "서주를 차지하고 여포를 소패에 내어준 유비", 1000, 11, "덕가", 3);
//////////////////////////국가8/////////////////////////////////////////////////
RegNation($connect, "마등", "808000", 10000, 10000, "서북지방을 제패한 서량태수 마등", 1000, 11, "병가", 4);
//////////////////////////국가9/////////////////////////////////////////////////
RegNation($connect, "여포", "A9A9A9", 10000, 10000, "조조에 패해 유비에게 의탁하게 된 맹장 여포", 1000, 9, "병가", 2);
//////////////////////////국가10/////////////////////////////////////////////////
RegNation($connect, "이각", "BA55D3", 10000, 10000, "황제를 뺏기고 위기에 몰린 동탁의 잔당세력", 1000, 7, "병가", 5);
//////////////////////////국가11/////////////////////////////////////////////////
RegNation($connect, "공손찬", "FF00FF", 10000, 10000, "백마부대를 바탕으로 원소와 패자를 다투는 북평태수 공손찬", 1000, 7, "병가", 3);
//////////////////////////국가12/////////////////////////////////////////////////
...
//////////////////////////국가15/////////////////////////////////////////////////
RegNation($connect, "장양", "483D8B", 10000, 10000, "장양", 1000, 2, "묵가", 3);
...
//원소2 공손찬11 전쟁
$query = "update diplomacy set state=1,term=36 where me=2 and you=11";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
$query = "update diplomacy set state=1,term=36 where you=2 and me=11";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
//////////////////////////외교 끝//////////////////////////////////////////////////

//////////////////////////장수//////////////////////////////////////////////////
//국가1  조조    국가2  원소  국가3  손책    국가4  유표  국가5  유장
//국가6  원술    국가7  유비  국가8  마등    국가9  여포  국가10 이각
//국가11 공손찬  국가12 장로  국가13 공손도  국가14 장연  국가15 장양
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1002,   1,     "헌제",$img,1002,  1,    "-", 17, 13, 61, 0, 170, 250, "안전",    "-", "산 넘어 산이로구나...");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1011,  20,     "가후",$img,1011, 10,    "-", 69, 30, 94, 0, 147, 223, "할거", "귀병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1012,  73,     "간옹",$img,1012,  7,    "-", 31, 33, 70, 0, 164, 225, "안전", "경작");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1013, 129,     "감녕",$img,1013,  4,    "-", 78, 95, 71, 0, 174, 222, "출세", "무쌍");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1020, 144,     "고순",$img,1020,  9,    "-", 79, 82, 65, 0, 162, 198, "의협", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1026, 142,   "공손강",$img,1026, 13,    "-", 64, 72, 61, 0, 172, 210, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1027, 142,   "공손공",$img,1027, 13,    "-", 68, 41, 75, 0, 174, 238, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1028, 142,   "공손도",$img,1028, 13,    "-", 62, 72, 41,12, 154, 204, "정복", "기병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1029,  65,   "공손범",$img,1029, 11,    "-", 61, 67, 61, 0, 158, 199, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1030,  65,   "공손속",$img,1030, 11,    "-", 60, 76, 41, 0, 176, 199, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1031,  10,   "공손연",$img,1031,  0,    "-", 74, 79, 64, 0, 205, 238, "패권", "돌격");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1032,  65,   "공손월",$img,1032, 11,    "-", 47, 63, 46, 0, 160, 192, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1033,  65,   "공손찬",$img,1033, 11,    "-", 61, 87, 67,12, 152, 199, "패권", "기병", "나의 백마부대는 천하 제일이오!");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1047,  76,     "관우",$img,1047,  7,    "-", 96, 98, 80, 0, 162, 219, "의협", "위압");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1053,  40,     "괴량",$img,1053,  4,    "-", 41, 28, 81, 0, 155, 204, "안전", "신중");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1054,  40,     "괴월",$img,1054,  4,    "-", 26, 30, 84, 0, 157, 214, "유지", "귀병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1059,  46,     "금선",$img,1059,  4,    "-", 55, 49, 36, 0, 155, 208, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1067, 127,     "능조",$img,1067,  3,    "-", 67, 80, 44, 0, 165, 203, "재간", "공성");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1068, 127,     "능통",$img,1068,  0,    "-", 71, 78, 58, 0, 189, 237, "의협", "궁병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1069,  64,     "단경",$img,1069, 11,    "-", 68, 61, 68, 0, 156, 199, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1080, 127,     "동습",$img,1080,  3,    "-", 53, 64, 32, 0, 169, 215, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1084,  66,     "동화",$img,1084,  5,    "-", 48, 64, 53, 0, 168, 219, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1094,  70,     "마등",$img,1094,  8,    "-", 80, 87, 56,12, 149, 211, "왕좌", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1097,  48,     "마완",$img,1097,  8,    "-", 49, 64, 26, 0, 170, 211, "안전", "기병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1098,  19,     "마준",$img,1098,  0,    "-", 45, 63, 62, 0, 196, 260, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1099,  71,     "마철",$img,1099,  8,    "-", 71, 60, 31, 0, 179, 211, "대의", "기병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1100,  70,     "마초",$img,1100,  8,    "-", 78, 97, 40, 0, 176, 226, "대의", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1103,  71,     "마휴",$img,1103,  8,    "-", 71, 60, 32, 0, 178, 211, "대의", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1106,  44,     "맹달",$img,1106,  5,    "-", 70, 66, 72, 0, 172, 228, "할거", "귀병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1118, 108,     "미방",$img,1118,  7,    "-", 58, 65, 37, 0, 169, 222, "패권", "징병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1119,  77,     "미축",$img,1119,  7,    "-", 26, 30, 65, 0, 165, 220, "왕좌", "상재");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1122,  65,     "방덕",$img,1122,  8,    "-", 76, 90, 67, 0, 170, 219, "의협", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1128,  72,     "법정",$img,1128,  5,    "-", 81, 29, 93, 0, 176, 220, "패권", "신산");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1129,   8,     "변희",$img,1129, 14,    "-", 65, 65, 27, 0, 169, 200, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1137,  66,     "비시",$img,1137,  5,    "-", 18, 36, 61, 0, 176, 240, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1164,  69,     "성의",$img,1164,  8,    "-", 45, 64, 22, 0, 168, 211, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1165, 129,     "소비",$img,1165,  4,    "-", 67, 63, 49, 0, 172, 221, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1166,  76,     "손건",$img,1166,  7,    "-", 42, 33, 73, 0, 165, 215, "대의", "거상");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1169, 125,     "손권",$img,1169,  3,    "-", 90, 77, 83, 0, 182, 252, "할거", "수비");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1176, 126,     "손유",$img,1176,  3,    "-", 77, 60, 67, 0, 177, 215, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1177, 122,     "손이",$img,1177,  0,    "-", 57, 62, 57, 0, 223, 272, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1178, 126,     "손정",$img,1178,  3,    "-", 59, 56, 62, 0, 160, 206, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1181, 125,     "손책",$img,1181,  3,    "-", 96, 96, 78,12, 175, 200, "패권", "필살", "이 소패왕 손책을 당해낼 자 누가 있으리오!");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1188, 147,     "송헌",$img,1188,  9,    "-", 42, 63, 41, 0, 157, 200, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1204,  14,     "양백",$img,1204, 12,    "-", 55, 54, 53, 0, 171, 214, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1205,  92,    "양봉1",$img,1205,  6,    "-", 57, 64, 36, 0, 153, 197, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1206,  91,    "양봉2",$img,1206,  0,    "-", 62, 78, 61, 0, 191, 252, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1207,  13,     "양송",$img,1207, 12,    "-", 15, 35, 34, 0, 167, 215, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1226, 123,     "여범",$img,1226,  3,    "-", 43, 34, 71, 0, 169, 228, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1229, 145,     "여포",$img,1229,  9,    "-", 74,100, 29,12, 156, 198, "패권", "돌격", "아무나 오거라 다 베어버리겠다!");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1232,  18,     "염포",$img,1232, 12,    "-", 33, 35, 77, 0, 163, 231, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1247,  57,     "왕루",$img,1247,  5,    "-", 40, 28, 76, 0, 173, 211, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1248,  76,     "왕보",$img,1248,  5,    "-", 47, 34, 75, 0, 171, 219, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1251,  46,     "왕위",$img,1251,  4,    "-", 59, 60, 68, 0, 163, 208, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1255,  30,     "왕찬",$img,1255,  4,    "-", 28, 28, 78, 0, 177, 217, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1264, 122,     "우번",$img,1264,  3,    "-", 23, 42, 73, 0, 164, 233, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1268, 101,     "원소",$img,1268,  2,    "-", 85, 67, 76,12, 154, 202, "패권", "위압", "나의 세력이 천하 으뜸이구나. 하하하.");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1269, 140,     "원술",$img,1269,  6,    "-", 77, 59, 71,12, 155, 199, "패권", "축성", "훗. 역시 미천한 것들이 하는 짓이란.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1273, 147,     "위속",$img,1273,  9,    "-", 57, 59, 41, 0, 156, 200, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1281,  75,     "유비",$img,1281,  7,    "-", 85, 75, 70,12, 161, 223, "왕좌", "인덕");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1282,  75,    "유선1",$img,1282,  0,    "-", 24, 17, 21, 0, 207, 271, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1283,  55,     "유순",$img,1283,  5,    "-", 67, 61, 54, 0, 184, 239, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1286,  55,     "유언",$img,1286,  5,    "-", 60, 40, 74, 0, 132, 194, "할거",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1287,  27,     "유엽",$img,1287,  1,    "-", 40, 29, 79, 0, 176, 235, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1288,  11,     "유요",$img,1288,  4,    "-", 23, 22, 48, 0, 156, 195, "안전", "발명");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1289,  96,     "유우",$img,1289,  0,    "-", 68, 34, 72, 0, 145, 193, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1290,  55,     "유장",$img,1290,  5,    "-", 38, 31, 63,12, 162, 219, "할거", "수비");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1293,  45,    "유표1",$img,1293,  4,    "-", 71, 57, 71,12, 142, 208, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1304,   2,     "이각",$img,1304, 10,    "-", 56, 77, 43,12, 148, 198, "패권",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1312,  66,     "이회",$img,1312,  5,    "-", 67, 50, 79, 0, 175, 231, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1317, 122,     "장굉",$img,1317,  3,    "-", 25, 21, 85, 0, 153, 212, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1318,   7,     "장량",$img,1318,  0,    "-", 68, 81, 68, 0, 153, 185, "정복", "환술");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1319,  15,     "장로",$img,1319, 12,    "-", 76, 44, 80,12, 163, 237, "유지", "축성", "오두미도는 도탄에 빠진 백성을 구해줄 것이오. 줄을 서시오~");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1320,  23,     "장료",$img,1320,  9,    "-", 89, 93, 83, 0, 169, 222, "의협", "견고");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1321,   7,     "장보",$img,1321,  0,    "-", 78, 81, 76, 0, 148, 185, "패권", "환술");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1322,  76,     "장비",$img,1322,  7,    "-", 79, 99, 48, 0, 167, 221, "의협", "무쌍");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1323,  62,     "장서",$img,1323,  0,    "-", 44, 48, 35, 0, 225, 290, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1324, 120,    "장소1",$img,1324,  3,    "-", 42, 24, 91, 0, 156, 236, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1325,  78,    "장소2",$img,1325,  0,    "-", 51, 44, 71, 0, 202, 264, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1326,  72,     "장송",$img,1326,  5,    "-", 49, 28, 93, 0, 170, 212, "할거", "통찰");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1327, 148,     "장수",$img,1327, 10,    "-", 71, 72, 69, 0, 154, 207, "할거",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1328, 145,    "장양1",$img,1328, 15,    "-", 62, 66, 65,12, 150, 199, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1329,   8,     "장연",$img,1329, 14,    "-", 78, 66, 47,12, 153, 210, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1333,  15,     "장위",$img,1333, 12,    "-", 65, 70, 29, 0, 172, 215, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1334,  36,     "장윤",$img,1334,  4,    "-", 67, 59, 60, 0, 163, 208, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1338, 148,    "장제1",$img,1338, 10,    "-", 70, 65, 59, 0, 144, 196, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1341,  17,     "장패",$img,1341,  9,    "-", 44, 78, 43, 0, 165, 231, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1350, 126,     "장흠",$img,1350,  3,    "-", 64, 66, 67, 0, 168, 219, "대의", "저격");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1361, 126,     "정보",$img,1361,  3,    "-", 81, 64, 76, 0, 151, 216, "패권",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1366,  69,     "정은",$img,1366,  8,    "-", 53, 62, 26, 0, 169, 211, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1383, 147,     "조성",$img,1383,  9,    "-", 44, 69, 51, 0, 163, 198, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1389,  76,     "조운",$img,1389, 11,    "-", 95, 98, 87, 0, 168, 229, "왕좌", "무쌍");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1392,  25,     "조조",$img,1392,  1,    "-",100, 80, 95,12, 155, 220, "패권", "반계", "천하의 명분은 내 손안에 들어왔도다.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1396,  84,     "조표",$img,1396,  7,    "-", 34, 70, 16, 0, 151, 196, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1403,  22,     "종요",$img,1403, 10,    "-", 16, 20, 74, 0, 151, 230, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1408, 126,     "주유",$img,1408,  3,    "-", 97, 73, 97, 0, 175, 210, "패권", "신산");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1413, 126,     "주치",$img,1413,  3,    "-", 58, 55, 56, 0, 156, 224, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1414,  41,    "주태1",$img,1414,  0,    "-", 62, 55, 61, 0, 207, 261, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1415, 126,    "주태2",$img,1415,  3,    "-", 74, 88, 60, 0, 171, 225, "정복", "필살");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1419,  28,     "진군",$img,1419,  7,    "-", 60, 38, 87, 0, 167, 235, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1420, 143,     "진궁",$img,1420,  9,    "-", 77, 51, 90, 0, 154, 198, "할거", "신중");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1421,  79,     "진규",$img,1421,  7,    "-", 22, 19, 71, 0, 132, 206, "할거",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1422,  72,     "진도",$img,1422,  0,    "-", 71, 85, 70, 0, 171, 237, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1423,  79,     "진등",$img,1423,  7,    "-", 64, 62, 71, 0, 169, 207, "할거",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1424,  37,     "진림",$img,1424,  2,    "-", 50, 28, 82, 0, 160, 217, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1425, 124,     "진무",$img,1425,  3,    "-", 62, 74, 59, 0, 176, 215, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1432,  21,     "차주",$img,1432,  1,    "-", 55, 66, 62, 0, 164, 199, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1433,  11,     "착융",$img,1433,  0,    "-", 62, 59, 21, 0, 161, 194, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1434,  36,     "채모",$img,1434,  4,    "-", 79, 69, 68, 0, 155, 208, "정복", "궁병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1435,  36,     "채중",$img,1435,  4,    "-", 58, 43, 55, 0, 168, 208, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1436,  36,     "채화",$img,1436,  4,    "-", 56, 47, 49, 0, 166, 208, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1437,  66,     "초주",$img,1437,  0,    "-", 22, 26, 81, 0, 201, 270, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1438,  20,     "최염",$img,1438,  2,    "-", 43, 54, 67, 0, 162, 216, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1441, 124,   "태사자",$img,1441,  3,    "-", 71, 97, 65, 0, 166, 209, "대의", "무쌍");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1446, 121,     "하제",$img,1446,  3,    "-", 74, 73, 64, 0, 171, 227, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1460, 126,     "한당",$img,1460,  3,    "-", 68, 67, 64, 0, 156, 225, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1463,  48,     "한수",$img,1463,  8,    "-", 66, 76, 77, 0, 142, 215, "대의", "기병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1464,  40,     "한숭",$img,1464,  4,    "-", 21, 25, 70, 0, 154, 210, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1465,   7,     "한충",$img,1465,  0,    "-", 41, 66, 29, 0, 151, 185, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1466,   9,     "한현",$img,1466,  4,    "-", 43, 61, 20, 0, 163, 208, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1467,  27,     "한호",$img,1467,  1,    "-", 60, 73, 45, 0, 164, 218, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1468,  79,     "향랑",$img,1468,  4,    "-", 51, 21, 77, 0, 167, 247, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1469,  79,     "향총",$img,1469,  0,    "-", 76, 42, 73, 0, 195, 240, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1470, 139,     "허공",$img,1470,  3,    "-", 65, 63, 59, 0, 155, 200, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1476, 148,   "호거아",$img,1476, 10,    "-", 35, 76, 61, 0, 164, 206, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1485, 127,     "황개",$img,1485,  3,    "-", 78, 85, 69, 0, 154, 218, "왕좌", "징병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1489,  72,     "황충",$img,1489,  4,    "-", 84, 94, 67, 0, 148, 222, "왕좌", "궁병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1490,  50,     "황호",$img,1490,  0,    "-", 15, 17, 48, 0, 226, 263, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1491, 147,     "후성",$img,1491,  9,    "-", 56, 62, 33, 0, 158, 199, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1502,  65,     "관정",$img,1502, 11,    "-", 35, 50, 73, 0, 158, 199,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1543,  36,   "성공영",$img,1543,  8,    "-", 73, 58, 80, 0, 172, 220,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1565,  16,     "양앙",$img,1565, 12,    "-", 65, 70, 39, 0, 172, 215,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1566,  17,     "양임",$img,1566, 12,    "-", 71, 78, 56, 0, 170, 215,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1569,  48,    "양추2",$img,1569,  8,    "-", 66, 67, 61, 0, 172, 238,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1575,  36,     "염행",$img,1575,  8,    "-", 70, 86, 38, 0, 159, 222,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1576,  73,     "영수",$img,1576,  0,    "-", 69, 70, 74, 0, 234, 264,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1577,  39,     "오거",$img,1577,  4,    "-", 49, 63, 32, 0, 151, 211,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1586,  63,     "왕문",$img,1586, 11,    "-", 64, 67, 32, 0, 162, 205,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1599,  45,     "유반",$img,1599,  4,    "-", 74, 79, 48, 0, 168, 210,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1631,  75,     "전예",$img,1631, 11,    "-", 80, 62, 83, 0, 171, 252,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1632,  64,     "전해",$img,1632, 11,    "-", 71, 63, 57, 0, 154, 199,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1661,   5,     "학맹",$img,1661,  9,    "-", 57, 66, 41, 0, 156, 197,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1674,  45,     "황조",$img,1674,  4,    "-", 74, 65, 57, 0, 148, 208,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1675,  48,     "후선",$img,1675,  8,    "-", 56, 66, 35, 0, 175, 228,    "-",    "-");
...
RegCity($connect, 3, "건업", 1);
RegCity($connect, 3, "오");
RegCity($connect, 3, "회계");
RegCity($connect, 4, "강릉");
RegCity($connect, 4, "무릉");
RegCity($connect, 4, "신야");
RegCity($connect, 4, "양양", 1);
RegCity($connect, 4, "강하");
RegCity($connect, 4, "장판");
RegCity($connect, 5, "면죽");
RegCity($connect, 5, "덕양");
RegCity($connect, 5, "자동");
RegCity($connect, 5, "성도", 1);
RegCity($connect, 5, "강주");
RegCity($connect, 6, "여남");
RegCity($connect, 6, "수춘", 1);
RegCity($connect, 6, "여강");
RegCity($connect, 6, "합비");
RegCity($connect, 7, "서주", 1);
RegCity($connect, 7, "하비");
RegCity($connect, 8, "서량", 1);
RegCity($connect, 8, "천수");
RegCity($connect, 9, "패", 1);
RegCity($connect, 10, "장안", 1);
RegCity($connect, 10, "홍농");
RegCity($connect, 10, "함곡");
RegCity($connect, 11, "계");
RegCity($connect, 11, "역경");
RegCity($connect, 11, "북평", 1);
RegCity($connect, 12, "한중", 1);
RegCity($connect, 12, "양평");
RegCity($connect, 13, "안평", 1);
RegCity($connect, 14, "진양", 1);
...
//////////////////////////이벤트///////////////////////////////////////////////
$history[count($history)] = "<C>●</>196년 1월:<L><b>【역사모드4】</b>황제는 허도로</>";
$history[count($history)] = "<C>●</>196년 1월:<L><b>【이벤트】</b></><Y>황제</>가 이각에게서 탈출하여 낙양으로 향합니다.";
$history[count($history)] = "<C>●</>196년 1월:<L><b>【이벤트】</b></><Y>황제</>는 폐허가 된 <G><b>낙양</b></>의 수비를 위해 몇 군벌들에게 서신을 띄웁니다..";
$history[count($history)] = "<C>●</>196년 1월:<L><b>【이벤트】</b></><G><b>기주</b></>의 <Y>원소</>는 세력 다지기에 바쁩니다.";
$history[count($history)] = "<C>●</>196년 1월:<L><b>【이벤트】</b></><G><b>연주</b></>의 <Y>조조</>가 병력을 출동하여 낙양을 점거합니다.";
$history[count($history)] = "<C>●</>196년 1월:<L><b>【이벤트】</b></><Y>조조</>는 황제를 강압적으로 허창으로 이주시킵니다.";

$history[count($history)] = "<C>●</>196년 1월:<L><b>【이벤트】</b></><Y>여포</>는 패주하여 <Y>유비</>에 몸을 맡깁니다.";
