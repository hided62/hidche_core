...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1001,   1,    "소제1",$img,1001,  1,    "-", 20, 11, 48, 0, 168, 190, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1002,   1,     "헌제",$img,1002,  1,    "-", 17, 13, 61, 0, 170, 250, "안전",    "-", "한 왕실을 구해줄 이는 진정 없는 것인가...");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1021,   7,     "고승",$img,1021,  2,    "-", 42, 73, 24, 0, 145, 185, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1025,  74,     "공도",$img,1025,  2,    "-", 26, 73, 19, 0, 164, 200, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1026, 142,   "공손강",$img,1026,  0,    "-", 64, 72, 61, 0, 172, 210, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1027, 142,   "공손공",$img,1027,  0,    "-", 68, 41, 75, 0, 174, 238, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1047,  76,     "관우",$img,1047,  1,    "-", 96, 98, 80, 0, 162, 219, "의협", "위압");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1051,   7,     "관해",$img,1051,  2,    "-", 66, 90, 35, 0, 160, 193, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1055,  98,     "교모",$img,1055,  1,    "-", 59, 58, 61, 0, 150, 191, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1059,  46,     "금선",$img,1059,  1,    "-", 55, 49, 36, 0, 155, 208, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1064,  75,     "노식",$img,1064,  1,    "-", 91, 54, 80, 0, 139, 192, "왕좌", "징병", "한 황실의 앞날이 심히 걱정되는구나...");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1074,  82,     "도겸",$img,1074,  1,    "-", 51, 32, 61, 0, 132, 194, "할거", "인덕");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1079,  21,     "동소",$img,1079,  0,    "-", 46, 46, 62, 0, 156, 236, "패권",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1083,   2,     "동탁",$img,1083,  1,    "-", 87, 91, 54, 0, 139, 192, "패권", "기병", "곧 기회가 올 것이다...");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1086,   7,     "등무",$img,1086,  2,    "-", 43, 74, 19, 0, 147, 185, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1100,  70,     "마초",$img,1100,  0,    "-", 78, 97, 40, 0, 176, 226, "대의", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1125,  68,   "배원소",$img,1125,  2,    "-", 45, 69, 33, 0, 169, 200, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1129,   8,     "변희",$img,1129,  2,    "-", 65, 65, 27, 0, 169, 200, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1167, 125,     "손견",$img,1167,  1,    "-", 96, 95, 76, 0, 156, 192, "왕좌", "무쌍", "나는 강동의 호랑이 손견이올씨다!");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1178, 126,     "손정",$img,1178,  1,    "-", 59, 56, 62, 0, 160, 206, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1179, 115,     "손준",$img,1179,  0,    "-", 59, 69, 51, 0, 219, 256, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1180,   7,     "손중",$img,1180,  2,    "-", 53, 63, 24, 0, 154, 185, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1192,  29,     "신비",$img,1192,  0,    "-", 47, 28, 74, 0, 171, 240, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1215,   6,   "어부라",$img,1215,  2,    "-", 78, 80, 61, 0, 150, 195, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1220,   7,     "엄정",$img,1220,  2,    "-", 31, 68, 49, 0, 151, 189, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1232,  18,     "염포",$img,1232,  0,    "-", 33, 35, 77, 0, 163, 231, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1239,  69,     "오의",$img,1239,  0,    "-", 75, 72, 74, 0, 165, 237, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1244,  97,     "왕광",$img,1244,  1,    "-", 72, 67, 54, 0, 150, 190, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1261,  74,     "요화",$img,1261,  2,    "-", 67, 58, 60, 0, 170, 264, "의협",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1268, 101,     "원소",$img,1268,  1,    "-", 85, 67, 76, 0, 154, 202, "패권", "위압", "4세 5공 명문집안 출신 원소라 하오!");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1269, 140,     "원술",$img,1269,  1,    "-", 77, 59, 71, 0, 155, 199, "패권", "축성");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1270, 140,     "원윤",$img,1270,  1,    "-", 41, 34, 60, 0, 163, 199, "패권",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1279,  46,     "유벽",$img,1279,  2,    "-", 63, 71, 23, 0, 168, 210, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1280,  75,     "유봉",$img,1280,  0,    "-", 60, 65, 62, 0, 188, 220, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1281,  75,     "유비",$img,1281,  1,    "-", 85, 75, 70, 0, 161, 223, "왕좌", "인덕");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1286,  55,     "유언",$img,1286,  1,    "-", 60, 40, 74, 0, 132, 194, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1289,  96,     "유우",$img,1289,  1,    "-", 68, 34, 72, 0, 145, 193, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1290,  55,     "유장",$img,1290,  1,    "-", 38, 31, 63, 0, 162, 219, "할거", "수비");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1293,  45,    "유표1",$img,1293,  1,    "-", 71, 57, 71, 0, 142, 208, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1314,   7,     "장각",$img,1314,  2,    "-", 93, 25, 93,12, 140, 185, "패권", "환술", "푸른 하늘은 가고 누런 하늘이 다가온다!");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1315,  34,     "장간",$img,1315,  0,    "-", 19, 20, 70, 0, 175, 239, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1316,   7,     "장개",$img,1316,  2,    "-", 48, 69, 19, 0, 155, 202, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1317, 122,     "장굉",$img,1317,  0,    "-", 25, 21, 85, 0, 153, 212, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1318,   7,     "장량",$img,1318,  2,    "-", 68, 81, 68, 0, 153, 185, "정복", "환술");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1319,  15,     "장로",$img,1319,  0,    "-", 76, 44, 80, 0, 163, 237, "유지", "축성");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1320,  23,     "장료",$img,1320,  0,    "-", 89, 93, 83, 0, 169, 222, "의협", "견고");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1321,   7,     "장보",$img,1321,  2,    "-", 78, 81, 76, 0, 148, 185, "패권", "환술");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1322,  76,     "장비",$img,1322,  1,    "-", 79, 99, 48, 0, 167, 221, "의협", "무쌍");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1328, 145,    "장양1",$img,1328,  1,    "-", 62, 66, 65, 0, 150, 199, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1329,   8,     "장연",$img,1329,  2,    "-", 78, 66, 47, 0, 153, 210, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1361, 126,     "정보",$img,1361,  1,    "-", 81, 64, 76, 0, 151, 216, "패권",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1364,  88,     "정원",$img,1364,  1,    "-", 64, 77, 58, 0, 137, 190, "왕좌", "기병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1365,   7,   "정원지",$img,1365,  2,    "-", 41, 74, 38, 0, 145, 185, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1397,   7,    "조홍1",$img,1397,  2,    "-", 52, 66, 42, 0, 156, 185, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1398,  24,    "조홍2",$img,1398,  0,    "-", 72, 69, 44, 0, 169, 232, "패권",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1401,  26,     "조휴",$img,1401,  0,    "-", 75, 71, 70, 0, 174, 228, "패권",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1410,  88,     "주준",$img,1410,  2,    "-", 82, 75, 65, 0, 149, 195, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1411,  32,     "주지",$img,1411,  0,    "-", 52, 77, 47, 0, 233, 295, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1412,  76,     "주창",$img,1412,  2,    "-", 42, 79, 30, 0, 164, 219, "의협", "궁병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1445,   7,     "하의",$img,1445,  2,    "-", 49, 68, 25, 0, 161, 195, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1446, 121,     "하제",$img,1446,  0,    "-", 74, 73, 64, 0, 171, 227, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1447,  90,     "하진",$img,1447,  1,    "-", 49, 69, 37,12, 135, 189, "왕좌",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1461,  93,     "한복",$img,1461,  1,    "-", 66, 59, 42, 0, 149, 191, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1462,   8,     "한섬",$img,1462,  2,    "-", 39, 62, 35, 0, 159, 196, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1465,   7,     "한충",$img,1465,  2,    "-", 41, 66, 29, 0, 151, 185, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1493, 999,     "건석",$img,1493,  1,    "-", 21, 12, 61, 0, 155, 189,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1502,  65,     "관정",$img,1502,  1,    "-", 35, 50, 73, 0, 158, 199,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1503, 137,     "교수",$img,1503,  1,    "-", 67, 69, 39, 0, 143, 195,    "-",    "-");
