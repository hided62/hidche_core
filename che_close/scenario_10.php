...
//////////////////////////국가1/////////////////////////////////////////////////
RegNation($connect, "조비", "000080", 10000, 10000, "정권을 안정시킨 조비", 1000, 96, "병가", 6);
//////////////////////////국가2/////////////////////////////////////////////////
RegNation($connect, "손권", "FF0000", 10000, 10000, "국력을 축적하는 손권", 1000, 49, "덕가", 4);
//////////////////////////국가3////////////////////////////////////////////////
RegNation($connect, "유비", "008000", 10000, 10000, "남만 정벌에 나서는 유선", 1000, 55, "유가", 4);
//////////////////////////국가4/////////////////////////////////////////////////
RegNation($connect, "맹획", "A0522D", 10000, 10000, "유선에 반기를 든 맹획", 1000, 15, "도적", 1);
//////////////////////////국가5/////////////////////////////////////////////////
RegNation($connect, "공손공", "A0522D", 10000, 10000, "공손공", 1000, 6, "도적", 1);
...
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
//유비3 맹획4 전쟁
$query = "update diplomacy set state=1,term=36 where me=3 and you=4";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
$query = "update diplomacy set state=1,term=36 where you=3 and me=4";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
//////////////////////////외교 끝//////////////////////////////////////////////////
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1008, 136,     "가범",$img,1008,  5,    "-", 58, 48, 73, 0, 202, 237, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1016,  73,     "강유",$img,1016,  1,    "-", 95, 90, 94, 0, 202, 264, "왕좌", "집중");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1023,  63,     "고정",$img,1023,  4,    "-", 67, 65, 55, 0, 190, 251, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1027, 142,   "공손공",$img,1027,  5,    "-", 68, 41, 75,12, 174, 238, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1031,  10,   "공손연",$img,1031,  5,    "-", 74, 79, 64, 0, 205, 238, "패권", "돌격");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1043,  27,     "곽혁",$img,1043,  1,    "-", 40, 29, 80, 0, 187, 228, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1060,  62, "금환삼결",$img,1060,  4,    "-", 46, 76, 17, 0, 192, 225, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1061, 141,     "기령",$img,1061,  0,    "-", 76, 81, 33, 0, 155, 199, "대의", "무쌍");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1062, 122,     "낙통",$img,1062,  2,    "-", 57, 44, 69, 0, 193, 228, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1073,  60, "대래동주",$img,1073,  4,    "-", 40, 65, 24, 0, 195, 249, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1077,  62,   "동다나",$img,1077,  4,    "-", 51, 71, 27, 0, 189, 225, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1098,  19,     "마준",$img,1098,  1,    "-", 45, 63, 62, 0, 196, 260, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1105,  51,   "망아장",$img,1105,  4,    "-", 29, 64, 20, 0, 191, 225, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1106,  44,     "맹달",$img,1106,  1,    "-", 70, 66, 72, 0, 172, 228, "할거", "귀병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1107,  60,     "맹우",$img,1107,  4,    "-", 63, 79, 26, 0, 190, 251, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1108,  60,     "맹획",$img,1108,  4,    "-", 78, 92, 50,12, 186, 245, "왕좌", "격노");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1109,  29,     "모개",$img,1109,  0,    "-", 46, 56, 56, 0, 161, 216, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1110,  51, "목록대왕",$img,1110,  4,    "-", 58, 71, 65, 0, 184, 225, "재간", "척사");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1128,  72,     "법정",$img,1128,  3,    "-", 81, 29, 93, 0, 176, 220, "패권", "신산");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1138, 141,     "비연",$img,1138,  5,    "-", 66, 65, 53, 0, 196, 238, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1169, 125,     "손권",$img,1169,  2,    "-", 90, 77, 83,12, 182, 252, "할거", "수비", "형주를 얻었으니 내실에 힘을 써야겠군...");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1170, 126,     "손랑",$img,1170,  2,    "-", 27, 54, 28, 0, 187, 226, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1185, 127,     "손환",$img,1185,  2,    "-", 79, 65, 70, 0, 197, 228, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1193,  37,     "신의",$img,1193,  1,    "-", 55, 61, 51, 0, 190, 252, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1194,  37,     "신탐",$img,1194,  1,    "-", 56, 58, 57, 0, 188, 254, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1199,  62,   "아회남",$img,1199,  4,    "-", 50, 74, 30, 0, 190, 225, "출세", "척사");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1202,  63,     "악환",$img,1202,  4,    "-", 54, 82, 55, 0, 196, 251, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1206,  91,    "양봉2",$img,1206,  4,    "-", 62, 78, 61, 0, 191, 252, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1210, 141,    "양조1",$img,1210,  5,    "-", 68, 54, 60, 0, 202, 256, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1222,  71,     "여개",$img,1222,  3,    "-", 51, 42, 67, 0, 194, 227, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1226, 123,     "여범",$img,1226,  2,    "-", 43, 34, 71, 0, 169, 228, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1231,  40,     "염유",$img,1231,  1,    "-", 59, 75, 51, 0, 168, 227, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1241,  51,   "올돌골",$img,1241,  4,    "-", 77, 92, 15, 0, 186, 225, "출세", "척사");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1242,  52,     "옹개",$img,1242,  4,    "-", 58, 67, 51, 0, 188, 225, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1246,  34,     "왕랑",$img,1246,  1,    "-", 49, 29, 51, 0, 162, 228, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1281,  75,     "유비",$img,1281,  3,    "-", 85, 75, 70,12, 161, 223, "왕좌", "인덕", "관우야.. 장비야..");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1282,  75,    "유선1",$img,1282,  3,    "-", 24, 17, 21, 0, 207, 271, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1302,  72,     "윤상",$img,1302,  1,    "-", 30, 32, 42, 0, 194, 260, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1303, 136,     "윤직",$img,1303,  5,    "-", 44, 58, 63, 0, 197, 237, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1381,  26,     "조비",$img,1381,  1,    "-", 72, 69, 75,12, 187, 226, "패권", "징병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1387,  25,     "조예",$img,1387,  1,    "-", 57, 55, 82, 0, 205, 239, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1390,  25,     "조웅",$img,1390,  1,    "-", 59, 27, 44, 0, 194, 220, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1415, 126,    "주태2",$img,1415,  2,    "-", 74, 88, 60, 0, 171, 225, "정복", "필살");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1426,  66,     "진복",$img,1426,  3,    "-", 36, 27, 76, 0, 160, 226, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1440,  60, "타사대왕",$img,1440,  4,    "-", 61, 72, 67, 0, 186, 225, "출세", "척사");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1446, 121,     "하제",$img,1446,  2,    "-", 74, 73, 64, 0, 171, 227, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1450,  19,   "하후무",$img,1450,  1,    "-", 38, 33, 37, 0, 201, 259, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1460, 126,     "한당",$img,1460,  2,    "-", 68, 67, 64, 0, 156, 225, "할거",    "-");
...
if($extend == 1) {
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1492, 123,     "가화",$img,1492,  2,    "-", 50, 66, 40, 0, 176, 224,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1529, 129,     "반장",$img,1529,  2,    "-", 77, 78, 69, 0, 177, 222,    "-",    "-");
...
//////////////////////////도시 소속/////////////////////////////////////////////
//국가1 조조  국가2 손권  국가3 유비  국가4 맹획  국가5 공손공
RegCity($connect, 1, "합비");
RegCity($connect, 1, "광릉");
RegCity($connect, 1, "역경");
RegCity($connect, 1, "계교");
RegCity($connect, 1, "관도");
RegCity($connect, 1, "정도");
RegCity($connect, 1, "서주");
...
RegCity($connect, 1, "계");
RegCity($connect, 1, "북평");
RegCity($connect, 1, "진양");
RegCity($connect, 1, "남피");
RegCity($connect, 1, "평원");
RegCity($connect, 1, "하내");
RegCity($connect, 1, "업");
RegCity($connect, 1, "북해");
...
RegCity($connect, 1, "패");
RegCity($connect, 1, "하비");
RegCity($connect, 1, "허창", 1);
RegCity($connect, 1, "초");
RegCity($connect, 1, "하비");
RegCity($connect, 1, "완");
RegCity($connect, 1, "여남");
RegCity($connect, 1, "수춘");
RegCity($connect, 1, "신야");
RegCity($connect, 1, "양양");
RegCity($connect, 1, "상용");
RegCity($connect, 2, "건업", 1);
RegCity($connect, 2, "파양");
RegCity($connect, 2, "적벽");
RegCity($connect, 2, "여강");
RegCity($connect, 2, "오");
RegCity($connect, 2, "회계");
RegCity($connect, 2, "시상");
RegCity($connect, 2, "강하");
RegCity($connect, 2, "장사");
RegCity($connect, 2, "계양");
RegCity($connect, 2, "강릉");
RegCity($connect, 2, "무릉");
RegCity($connect, 2, "영릉");
RegCity($connect, 2, "이릉");
RegCity($connect, 3, "한중");
RegCity($connect, 3, "양평");
RegCity($connect, 3, "하변");
RegCity($connect, 3, "가맹");
RegCity($connect, 3, "자동");
RegCity($connect, 3, "면죽");
RegCity($connect, 3, "성도", 1);
RegCity($connect, 3, "덕양");
RegCity($connect, 3, "영안");
RegCity($connect, 3, "강주");
RegCity($connect, 3, "주시");
RegCity($connect, 3, "귀양");
RegCity($connect, 4, "운남");
RegCity($connect, 4, "건녕", 1);
RegCity($connect, 4, "남만");
RegCity($connect, 5, "안평", 1);
...
//////////////////////////이벤트///////////////////////////////////////////////
$history[count($history)] = "<C>●</>225년 1월:<L><b>【역사모드10】</b>칠종칠금</>";
$history[count($history)] = "<C>●</>225년 1월:<L><b>【이벤트】</b></><G><b>위</b></>의 <Y>조조</>는 <Y>조비</>에게 후사를 부탁합니다.";
