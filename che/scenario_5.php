...
//////////////////////////국가1/////////////////////////////////////////////////
RegNation($connect, "조조", "000080", 10000, 10000, "원소와의 운명의 한판을 준비하는 조조", 1000, 48, "병가", 5);
//////////////////////////국가2/////////////////////////////////////////////////
RegNation($connect, "손책", "FF0000", 10000, 10000, "강동을 제패한 소패왕 손책", 1000, 37, "병가", 3);
//////////////////////////국가3/////////////////////////////////////////////////
RegNation($connect, "원소", "FFFF00", 10000, 10000, "조조와 일생일대의 대전을 벌이는 원소", 1000, 29, "법가", 4);
//////////////////////////국가4/////////////////////////////////////////////////
RegNation($connect, "유표", "E0FFFF", 10000, 10000, "형주에 기반을 다진 강하팔준 형주자사 유표", 1000, 26, "유가", 4);
//////////////////////////국가5/////////////////////////////////////////////////
RegNation($connect, "유장", "483D8B", 10000, 10000, "익주에 세력을 굳힌 익주자사 유장", 1000, 21, "유가", 4);
//////////////////////////국가6/////////////////////////////////////////////////
RegNation($connect, "마등", "808000", 10000, 10000, "서북지방을 제패한 서량태수 마등", 1000, 13, "병가", 4);
//////////////////////////국가7/////////////////////////////////////////////////
RegNation($connect, "장로", "20B2AA", 10000, 10000, "한중의 오두미도 장로", 1000, 7, "오두미도", 1);
//////////////////////////국가8////////////////////////////////////////////////
RegNation($connect, "유비", "008000", 10000, 10000, "서주를 빼앗기고 형제들과 헤어져 방랑하는 유비", 1000, 5, "덕가", 0);
//////////////////////////국가9/////////////////////////////////////////////////
...
//////////////////////////장수//////////////////////////////////////////////////
//국가1 조조  국가2 손책  국가3 원소  국가4 유표  국가5 유장
//국가6 마등  국가7 장로  국가8 유비  국가9 공손도
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1012,  73,     "간옹",$img,1012,  8,    "-", 31, 33, 70, 0, 164, 225, "안전", "경작");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1017, 102,     "고간",$img,1017,  3,    "-", 60, 57, 51, 0, 168, 206, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1018,  27,     "고람",$img,1018,  3,    "-", 72, 67, 59, 0, 159, 201, "출세", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1026, 142,   "공손강",$img,1026,  9,    "-", 64, 72, 61, 0, 172, 210, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1027, 142,   "공손공",$img,1027,  9,    "-", 68, 41, 75, 0, 174, 238, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1028, 142,   "공손도",$img,1028,  9,    "-", 62, 72, 41,12, 154, 204, "정복", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1038, 111,     "곽도",$img,1038,  3,    "-", 63, 67, 81, 0, 155, 205, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1042,  67,     "곽준",$img,1042,  4,    "-", 76, 69, 73, 0, 178, 217, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1047,  76,     "관우",$img,1047,  1,    "-", 96, 98, 80, 0, 162, 219, "의협", "위압", "언제쯤 형님을 다시 뵐 수 있을지...");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1099,  71,     "마철",$img,1099,  6,    "-", 71, 60, 31, 0, 179, 211, "대의", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1103,  71,     "마휴",$img,1103,  6,    "-", 71, 60, 32, 0, 178, 211, "대의", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1113,  28,     "문빙",$img,1113,  4,    "-", 70, 77, 43, 0, 178, 237, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1129,   8,     "변희",$img,1129,  1,    "-", 65, 65, 27, 0, 169, 200, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1132, 110,     "봉기",$img,1132,  3,    "-", 68, 52, 80, 0, 153, 202, "패권", "집중");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1135,  38,     "부손",$img,1135,  4,    "-", 24, 43, 68, 0, 162, 230, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1166,  76,     "손건",$img,1166,  8,    "-", 42, 33, 73, 0, 165, 215, "대의", "거상");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1169, 125,     "손권",$img,1169,  2,    "-", 90, 77, 83, 0, 182, 252, "할거", "수비");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1181, 125,     "손책",$img,1181,  2,    "-", 96, 96, 78,12, 175, 200, "패권", "필살", "강동을 제패한 소패왕 손책이외다!");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1189,  95,   "순우경",$img,1189,  3,    "-", 72, 67, 60, 0, 146, 200, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1192,  29,     "신비",$img,1192,  3,    "-", 47, 28, 74, 0, 171, 240, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1195,  85,     "신평",$img,1195,  3,    "-", 68, 51, 75, 0, 165, 204, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1196, 102,     "심배",$img,1196,  3,    "-", 75, 66, 68, 0, 156, 204, "패권", "귀병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1203, 102,     "안량",$img,1203,  3,    "-", 73, 93, 36, 0, 160, 200, "출세", "위압");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1204,  14,     "양백",$img,1204,  7,    "-", 55, 54, 53, 0, 171, 214, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1207,  13,     "양송",$img,1207,  7,    "-", 15, 35, 34, 0, 167, 215, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1224, 107,     "여광",$img,1224,  3,    "-", 60, 67, 27, 0, 162, 207, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1227, 107,     "여상",$img,1227,  3,    "-", 62, 68, 26, 0, 164, 207, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1228, 105,   "여위황",$img,1228,  3,    "-", 42, 62, 38, 0, 159, 200, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1231,  40,     "염유",$img,1231,  3,    "-", 59, 75, 51, 0, 168, 227, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1232,  18,     "염포",$img,1232,  7,    "-", 33, 35, 77, 0, 163, 231, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1249,  86,     "왕수",$img,1249,  3,    "-", 34, 34, 67, 0, 168, 218, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1266,  86,     "원담",$img,1266,  3,    "-", 67, 59, 55, 0, 173, 205, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1267, 101,     "원상",$img,1267,  3,    "-", 54, 72, 68, 0, 179, 207, "패권",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1268, 101,     "원소",$img,1268,  3,    "-", 85, 67, 76,12, 154, 202, "패권", "위압", "핫핫핫. 조조쯤이야.");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1269, 140,     "원술",$img,1269,  0,    "-", 77, 59, 71, 0, 155, 199, "패권", "축성", "옥새를 가진 나야 말로 진정한 황제라 할 수 있지!");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1270, 140,     "원윤",$img,1270,  0,    "-", 41, 34, 60, 0, 163, 199, "패권",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1271, 101,     "원희",$img,1271,  3,    "-", 69, 57, 72, 0, 176, 207, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1281,  75,     "유비",$img,1281,  8,    "-", 85, 75, 70,12, 161, 223, "왕좌", "인덕", "관우가 날 저버렸다니... 믿을 수 없다.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1319,  15,     "장로",$img,1319,  7,    "-", 76, 44, 80,12, 163, 237, "유지", "축성", "쌀 다섯말만 가져오시오. 모두 고쳐드리리다.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1322,  76,     "장비",$img,1322,  0,    "-", 79, 99, 48, 0, 167, 221, "의협", "무쌍");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1333,  15,     "장위",$img,1333,  7,    "-", 65, 70, 29, 0, 172, 215, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1334,  36,     "장윤",$img,1334,  4,    "-", 67, 59, 60, 0, 163, 208, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1335, 104,   "장의거",$img,1335,  3,    "-", 68, 59, 34, 0, 159, 205, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1344,  27,     "장합",$img,1344,  3,    "-", 83, 91, 63, 0, 167, 231, "출세", "궁병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1347,  48,     "장횡",$img,1347,  6,    "-", 53, 67, 25, 0, 178, 211, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1351,  96,     "저수",$img,1351,  3,    "-", 82, 54, 88, 0, 156, 201, "할거", "반계");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1357,  42,     "전주",$img,1357,  3,    "-", 69, 67, 51, 0, 169, 214, "의협",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1358,  96,     "전풍",$img,1358,  3,    "-", 81, 41, 96, 0, 162, 200, "왕좌",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1380,  83,     "조범",$img,1380,  4,    "-", 58, 40, 63, 0, 168, 218, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1392,  25,     "조조",$img,1392,  1,    "-",100, 80, 95,12, 155, 220, "패권", "반계", "위기는 기회로다.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1424,  37,     "진림",$img,1424,  3,    "-", 50, 28, 82, 0, 160, 217, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1425, 124,     "진무",$img,1425,  2,    "-", 62, 74, 59, 0, 176, 215, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1426,  66,     "진복",$img,1426,  5,    "-", 36, 27, 76, 0, 160, 226, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1438,  20,     "최염",$img,1438,  3,    "-", 43, 54, 67, 0, 162, 216, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1470, 139,     "허공",$img,1470,  2,    "-", 65, 63, 59, 0, 155, 200, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1471,  21,     "허유",$img,1471,  3,    "-", 47, 47, 57, 0, 155, 204, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1477,  76,     "호반",$img,1477,  1,    "-", 61, 58, 46, 0, 179, 233, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1497, 101,     "고유",$img,1497,  3,    "-", 56, 44, 73, 0, 174, 263,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1509,  34,     "금의",$img,1509,  4,    "-", 18, 40, 63, 0, 177, 218,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1546,  46,     "소유",$img,1546,  3,    "-", 51, 61, 48, 0, 164, 210,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1554,  85,     "순심",$img,1554,  3,    "-", 20, 21, 79, 0, 164, 208,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1565,  16,     "양앙",$img,1565,  7,    "-", 65, 70, 39, 0, 172, 215,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1566,  17,     "양임",$img,1566,  7,    "-", 71, 78, 56, 0, 170, 215,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1586,  63,     "왕문",$img,1586,  3,    "-", 64, 67, 32, 0, 162, 205,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1608,  48,     "이감",$img,1608,  6,    "-", 59, 67, 33, 0, 176, 211,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1626,  96,     "저곡",$img,1626,  3,    "-", 57, 53, 67, 0, 184, 204,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1662,  98,   "한거자",$img,1662,  3,    "-", 53, 59, 30, 0, 158, 200,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1677,  98,   "휴원진",$img,1677,  3,    "-", 53, 63, 38, 0, 155, 200,    "-",    "-");
...
RegCity($connect, 3, "역경");
RegCity($connect, 3, "계교");
RegCity($connect, 3, "호관");
RegCity($connect, 3, "관도");
RegCity($connect, 3, "계");
RegCity($connect, 3, "북평");
RegCity($connect, 3, "진양");
RegCity($connect, 3, "남피");
RegCity($connect, 3, "평원");
RegCity($connect, 3, "하내");
RegCity($connect, 3, "업", 1);
RegCity($connect, 3, "북해");
...
RegCity($connect, 4, "장사");
RegCity($connect, 4, "영릉");
RegCity($connect, 4, "계양");
...
RegCity($connect, 7, "한중", 1);
RegCity($connect, 7, "양평");
RegCity($connect, 9, "안평", 1);
...
//////////////////////////이벤트///////////////////////////////////////////////
$history[count($history)] = "<C>●</>200년 1월:<L><b>【역사모드5】</b>관도대전</>";
$history[count($history)] = "<C>●</>200년 1월:<L><b>【이벤트】</b></><Y>조조</>에게 패한 <Y>유비</>는 원소에게 의지하기 위해 방랑하고 있습니다.";
