...
//////////////////////////국가1/////////////////////////////////////////////////
RegNation($connect, "조조", "000080", 10000, 10000, "한중을 잃고 퇴각한 조조", 1000, 77, "병가", 6);
//////////////////////////국가2/////////////////////////////////////////////////
RegNation($connect, "손권", "FF0000", 10000, 10000, "형주를 되돌려 받기 위해 고심하는 손권", 1000, 44, "덕가", 4);
//////////////////////////국가3////////////////////////////////////////////////
RegNation($connect, "유비", "008000", 10000, 10000, "한중왕에 오른 유비", 1000, 71, "유가", 4);
//////////////////////////국가4/////////////////////////////////////////////////
RegNation($connect, "공손공", "A0522D", 10000, 10000, "공손공", 1000, 4, "도적", 1);
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1012,  73,     "간옹",$img,1012,  3,    "-", 31, 33, 70, 0, 164, 225, "안전", "경작");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1013, 129,     "감녕",$img,1013,  2,    "-", 78, 95, 71, 0, 174, 222, "출세", "무쌍");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1047,  76,     "관우",$img,1047,  3,    "-", 96, 98, 80, 0, 162, 219, "의협", "위압", "나의 수염은 천하 제일이라오.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1050,  76,     "관평",$img,1050,  3,    "-", 77, 80, 70, 0, 186, 219, "의협", "보병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1070, 132,     "담웅",$img,1070,  2,    "-", 52, 77, 19, 0, 188, 221, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1096,  77,     "마량",$img,1096,  3,    "-", 57, 25, 87, 0, 187, 225, "왕좌",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1101, 131,    "마충1",$img,1101,  2,    "-", 67, 62, 51, 0, 186, 222, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1118, 108,     "미방",$img,1118,  3,    "-", 58, 65, 37, 0, 169, 222, "패권", "징병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1119,  77,     "미축",$img,1119,  3,    "-", 26, 30, 65, 0, 165, 220, "왕좌", "상재");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1120,  94,     "반봉",$img,1120,  0,    "-", 61, 75, 17, 0, 155, 191, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1121,  44,     "반준",$img,1121,  3,    "-", 41, 21, 67, 0, 174, 239, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1122,  65,     "방덕",$img,1122,  1,    "-", 76, 90, 67, 0, 170, 219, "의협", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1133,  74,     "부동",$img,1133,  3,    "-", 58, 69, 69, 0, 183, 222, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1134, 108,   "부사인",$img,1134,  3,    "-", 54, 59, 51, 0, 182, 222, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1152, 132,     "사정",$img,1152,  2,    "-", 67, 71, 20, 0, 178, 221, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1165, 129,     "소비",$img,1165,  2,    "-", 67, 63, 49, 0, 172, 221, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1219,  69,     "엄안",$img,1219,  3,    "-", 72, 84, 67, 0, 151, 222, "왕좌",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1225, 124,     "여몽",$img,1225,  2,    "-", 92, 78, 93, 0, 178, 219, "패권", "궁병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1248,  76,     "왕보",$img,1248,  3,    "-", 47, 34, 75, 0, 171, 219, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1280,  75,     "유봉",$img,1280,  3,    "-", 60, 65, 62, 0, 188, 220, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1281,  75,     "유비",$img,1281,  3,    "-", 85, 75, 70,12, 161, 223, "왕좌", "인덕", "이제야 내 기반이 잡혀가는구나.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1290,  55,     "유장",$img,1290,  3,    "-", 38, 31, 63, 0, 162, 219, "할거", "수비");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1291,  45,     "유종",$img,1291,  0,    "-", 22, 26, 61, 0, 191, 208, "할거",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1292,  56,     "유파",$img,1292,  3,    "-", 47, 32, 70, 0, 186, 222, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1308, 132,     "이이",$img,1308,  2,    "-", 55, 75, 20, 0, 187, 222, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1322,  76,     "장비",$img,1322,  3,    "-", 79, 99, 48, 0, 167, 221, "의협", "무쌍", "으하하. 술맛 좋구나.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1376,  74,     "조루",$img,1376,  3,    "-", 49, 37, 60, 0, 183, 219, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1381,  26,     "조비",$img,1381,  1,    "-", 72, 69, 75, 0, 187, 226, "패권", "징병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1392,  25,     "조조",$img,1392,  1,    "-",100, 80, 95,12, 155, 220, "패권", "반계", "유비 이놈...");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1393,  26,     "조진",$img,1393,  1,    "-", 82, 67, 65, 0, 185, 231, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1394,  25,     "조창",$img,1394,  1,    "-", 75, 88, 37, 0, 190, 223, "정복", "돌격");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1412,  76,     "주창",$img,1412,  3,    "-", 42, 79, 30, 0, 164, 219, "의협", "궁병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1413, 126,     "주치",$img,1413,  2,    "-", 58, 55, 56, 0, 156, 224, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1444,  74,     "풍습",$img,1444,  3,    "-", 36, 64, 44, 0, 182, 222, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1451,  24,   "하후상",$img,1451,  1,    "-", 67, 62, 71, 0, 181, 225, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1474,  87,     "허정",$img,1474,  3,    "-", 18, 29, 74, 0, 152, 222, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1486,  56,     "황권",$img,1486,  3,    "-", 76, 46, 77, 0, 167, 240, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1507,  21,     "국연",$img,1507,  1,    "-", 52, 21, 71, 0, 160, 219,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1543,  36,   "성공영",$img,1543,  1,    "-", 73, 58, 80, 0, 172, 220,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1548, 126,     "손교",$img,1548,  2,    "-", 77, 60, 69, 0, 181, 219,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1575,  36,     "염행",$img,1575,  1,    "-", 70, 86, 38, 0, 159, 222,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1579, 999,   "오국태",$img,1579,  2,    "-", 31, 11, 60, 0, 161, 222,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1580, 126,     "오찬",$img,1580,  2,    "-", 69, 41, 78, 0, 181, 245,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1581,  23,     "온회",$img,1581,  1,    "-", 42, 40, 78, 0, 178, 222,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1614,  21,     "장기",$img,1614,  1,    "-", 77, 35, 79, 0, 170, 223,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1615,  74,     "장남",$img,1615,  3,    "-", 71, 64, 38, 0, 187, 222,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1634,  22,     "정의",$img,1634,  1,    "-", 17,  3, 66, 0, 184, 220,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1670,   7,     "환계",$img,1670,  1,    "-", 12, 25, 67, 0, 156, 221,    "-",    "-");
...
//////////////////////////이벤트///////////////////////////////////////////////
$history[count($history)] = "<C>●</>219년 1월:<L><b>【역사모드9】</b>삼국정립</>";
$history[count($history)] = "<C>●</>219년 1월:<L><b>【이벤트】</b></><G><b>한중</b></>을 빼앗긴 <Y>조조</>는 <G><b>허창</b></>으로 퇴각합니다.";
