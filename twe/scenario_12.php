...
//////////////////////////국가1/////////////////////////////////////////////////
RegNation("원소", "#FFFF00", 10000, 10000, "4세 5공 명문 혈통 기주 패자 원소", 1000, 40, "법가", 2);
//////////////////////////국가2/////////////////////////////////////////////////
RegNation("공손찬", "#FF00FF", 10000, 10000, "병주 패자 북평 태수 공손찬", 1000, 26, "병가", 3);
//////////////////////////국가3/////////////////////////////////////////////////
RegNation("동탁", "#A9A9A9", 10000, 10000, "천하 권력을 노리는 동탁", 1500, 25, "법가", 5);
//////////////////////////국가4/////////////////////////////////////////////////
RegNation("원술", "#FFC0CB", 10000, 10000, "4세 5공 명문 혈통 원소의 사촌 원술", 1000, 25, "병가", 2);
//////////////////////////국가5/////////////////////////////////////////////////
RegNation("유언", "#483D8B", 10000, 10000, "익주 주자사 유언", 1000, 10, "유가", 3);
//////////////////////////국가6/////////////////////////////////////////////////
RegNation("마등", "#808000", 10000, 10000, "서량 태수 마등", 1000, 9, "병가", 3);
//////////////////////////국가7/////////////////////////////////////////////////
RegNation("유표", "#E0FFFF", 10000, 10000, "강하팔준 명성의 유표", 1000, 9, "유가", 3);
//////////////////////////국가8/////////////////////////////////////////////////
RegNation("장로", "#20B2AA", 10000, 10000, "한중의 오두미도 장로", 1000, 7, "오두미도", 1);
//////////////////////////국가9/////////////////////////////////////////////////
RegNation("유우", "#6495ED", 10000, 10000, "황실 혈통 유우", 1000, 4, "유가", 3);
//////////////////////////국가10////////////////////////////////////////////////
RegNation("공손도", "#A0522D", 10000, 10000, "공손도", 1000, 3, "도적", 1);
//////////////////////////국가11////////////////////////////////////////////////
RegNation("장양", "#483D8B", 10000, 10000, "장양", 1000, 3, "묵가", 3);
//////////////////////////국가12////////////////////////////////////////////////
RegNation("공주", "#800080", 10000, 10000, "공주", 1000, 3, "도가", 3);
//////////////////////////국가13////////////////////////////////////////////////
RegNation("장연", "#87CEEB", 10000, 10000, "장연", 1000, 3, "도가", 2);
