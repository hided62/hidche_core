...
//조조1 원상7 전쟁
$query = "update diplomacy set state=1,term=36 where me=1 and you=7";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
$query = "update diplomacy set state=1,term=36 where you=1 and me=7";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
//원상7 원담9 전쟁
$query = "update diplomacy set state=1,term=36 where me=7 and you=9";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
$query = "update diplomacy set state=1,term=36 where you=7 and me=9";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
//////////////////////////외교 끝//////////////////////////////////////////////////
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1012,  73,     "간옹",$img,1012,  6,    "-", 31, 33, 70, 0, 164, 225, "안전", "경작");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1038, 111,     "곽도",$img,1038,  9,    "-", 63, 67, 81, 0, 155, 205, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1047,  76,     "관우",$img,1047,  6,    "-", 96, 98, 80, 0, 162, 219, "의협", "위압");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1050,  76,     "관평",$img,1050,  6,    "-", 77, 80, 70, 0, 186, 219, "의협", "보병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1059,  46,     "금선",$img,1059,  3,    "-", 55, 49, 36, 0, 155, 208, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1067, 127,     "능조",$img,1067,  2,    "-", 67, 80, 44, 0, 165, 203, "재간", "공성");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1106,  44,     "맹달",$img,1106,  4,    "-", 70, 66, 72, 0, 172, 228, "할거", "귀병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1113,  28,     "문빙",$img,1113,  3,    "-", 70, 77, 43, 0, 178, 237, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1114,  38,     "문앙",$img,1114,  0,    "-", 71, 91, 46, 0, 222, 285, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1115, 102,     "문추",$img,1115,  3,    "-", 72, 94, 25, 0, 161, 200, "출세", "무쌍");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1118, 108,     "미방",$img,1118,  6,    "-", 58, 65, 37, 0, 169, 222, "패권", "징병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1119,  77,     "미축",$img,1119,  6,    "-", 26, 30, 65, 0, 165, 220, "왕좌", "상재");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1128,  72,     "법정",$img,1128,  4,    "-", 81, 29, 93, 0, 176, 220, "패권", "신산");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1132, 110,     "봉기",$img,1132,  7,    "-", 68, 52, 80, 0, 153, 202, "패권", "집중");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1135,  38,     "부손",$img,1135,  3,    "-", 24, 43, 68, 0, 162, 230, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1166,  76,     "손건",$img,1166,  6,    "-", 42, 33, 73, 0, 165, 215, "대의", "거상");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1169, 125,     "손권",$img,1169,  2,    "-", 90, 77, 83,12, 182, 252, "할거", "수비", "지세를 이용해 세력을 굳히자...");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1181, 125,     "손책",$img,1181,  2,    "-", 96, 96, 78, 0, 175, 200, "패권", "필살");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1192,  29,     "신비",$img,1192,  9,    "-", 47, 28, 74, 0, 171, 240, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1195,  85,     "신평",$img,1195,  9,    "-", 68, 51, 75, 0, 165, 204, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1196, 102,     "심배",$img,1196,  7,    "-", 75, 66, 68, 0, 156, 204, "패권", "귀병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1224, 107,     "여광",$img,1224,  9,    "-", 60, 67, 27, 0, 162, 207, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1227, 107,     "여상",$img,1227,  9,    "-", 62, 68, 26, 0, 164, 207, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1247,  57,     "왕루",$img,1247,  4,    "-", 40, 28, 76, 0, 173, 211, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1248,  76,     "왕보",$img,1248,  4,    "-", 47, 34, 75, 0, 171, 219, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1249,  86,     "왕수",$img,1249,  9,    "-", 34, 34, 67, 0, 168, 218, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1255,  30,     "왕찬",$img,1255,  3,    "-", 28, 28, 78, 0, 177, 217, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1266,  86,     "원담",$img,1266,  9,    "-", 67, 59, 55,12, 173, 205, "왕좌",    "-", "꼭 하북의 실권을 되찾아 오겠다...");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1267, 101,     "원상",$img,1267,  7,    "-", 54, 72, 68,12, 179, 207, "패권",    "-", "흥. 내가 진정한 후계자이다.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1271, 101,     "원희",$img,1271,  7,    "-", 69, 57, 72, 0, 176, 207, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1281,  75,     "유비",$img,1281,  6,    "-", 85, 75, 70,12, 161, 223, "왕좌", "인덕", "내 떠돌이 생활은 언제쯤 끝이 나려나...");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1291,  45,     "유종",$img,1291,  3,    "-", 22, 26, 61, 0, 191, 208, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1319,  15,     "장로",$img,1319,  8,    "-", 76, 44, 80,12, 163, 237, "유지", "축성", "오두미도는 도탄에 빠진 백성들을 구제해 줄 것이오.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1322,  76,     "장비",$img,1322,  6,    "-", 79, 99, 48, 0, 167, 221, "의협", "무쌍");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1334,  36,     "장윤",$img,1334,  3,    "-", 67, 59, 60, 0, 163, 208, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1335, 104,   "장의거",$img,1335,  7,    "-", 68, 59, 34, 0, 159, 205, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1357,  42,     "전주",$img,1357,  7,    "-", 69, 67, 51, 0, 169, 214, "의협",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1389,  76,     "조운",$img,1389,  6,    "-", 95, 98, 87, 0, 168, 229, "왕좌", "무쌍", "떠돌이 생활이지만 주군을 만나 행복하구나.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1392,  25,     "조조",$img,1392,  1,    "-",100, 80, 95,12, 155, 220, "패권", "반계", "이제 날 당해낼 놈들은 없군.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1412,  76,     "주창",$img,1412,  6,    "-", 42, 79, 30, 0, 164, 219, "의협", "궁병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1421,  79,     "진규",$img,1421,  1,    "-", 22, 19, 71, 0, 132, 206, "할거",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1422,  72,     "진도",$img,1422,  6,    "-", 71, 85, 70, 0, 171, 237, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1423,  79,     "진등",$img,1423,  1,    "-", 64, 62, 71, 0, 169, 207, "할거",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1424,  37,     "진림",$img,1424,  7,    "-", 50, 28, 82, 0, 160, 217, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1429,  79,     "진진",$img,1429,  7,    "-", 58, 38, 64, 0, 170, 235, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1477,  76,     "호반",$img,1477,  6,    "-", 61, 58, 46, 0, 179, 233, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1509,  34,     "금의",$img,1509,  3,    "-", 18, 40, 63, 0, 177, 218,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1551, 125,     "손익",$img,1551,  2,    "-", 69, 75, 26, 0, 184, 204,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1578, 126,     "오경",$img,1578,  2,    "-", 73, 60, 57, 0, 159, 203,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1590,  35,     "왕충",$img,1590,  1,    "-", 42, 58, 21, 0, 152, 214,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1593, 138,     "원요",$img,1593,  2,    "-", 44, 42, 45, 0, 177, 206,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1631,  75,     "전예",$img,1631,  0,    "-", 80, 62, 83, 0, 171, 252,    "-",    "-");
...
//////////////////////////이벤트///////////////////////////////////////////////
$history[count($history)] = "<C>●</>202년 1월:<L><b>【역사모드6】</b>원가의 분열</>";
$history[count($history)] = "<C>●</>202년 1월:<L><b>【이벤트】</b></><Y>원소</>는 후계자로 셋째 아들 <Y>원상</>을 선택합니다.";
