...
//////////////////////////국가1/////////////////////////////////////////////////
RegNation($connect, "조조", "000080", 10000, 10000, "하북을 제패하고 대군을 이끌고 남하하는 조조", 1000, 73, "병가", 6);
//////////////////////////국가2/////////////////////////////////////////////////
RegNation($connect, "손권", "FF0000", 10000, 10000, "조조의 남하에 유비와 불가침으로 맞서는 손권", 1000, 49, "덕가", 4);
//////////////////////////국가3/////////////////////////////////////////////////
RegNation($connect, "유장", "483D8B", 10000, 10000, "익주에 만족하는 익주자사 유장", 1000, 25, "유가", 4);
//////////////////////////국가4////////////////////////////////////////////////
RegNation($connect, "유비", "008000", 10000, 10000, "공명의 영입과 손씨와의 불가침으로 반전을 꾀하는 유비", 1000, 18, "유가", 2);
//////////////////////////국가5/////////////////////////////////////////////////
...
//////////////////////////국가7/////////////////////////////////////////////////
RegNation($connect, "한현", "FF6347", 10000, 10000, "장사태수 한현", 1000, 4, "묵가", 2);
//////////////////////////국가8/////////////////////////////////////////////////
RegNation($connect, "조범", "808000", 10000, 10000, "계양태수 조범", 1000, 3, "도가", 2);
//////////////////////////국가9/////////////////////////////////////////////////
RegNation($connect, "유도", "AFEEEE", 10000, 10000, "영릉태수 유도", 1000, 3, "덕가", 2);
//////////////////////////국가10/////////////////////////////////////////////////
RegNation($connect, "공손강", "A0522D", 10000, 10000, "공손강", 1000, 2, "도적", 1);
//////////////////////////국가11/////////////////////////////////////////////////
RegNation($connect, "금선", "800080", 10000, 10000, "무릉태수 금선", 1000, 2, "도가", 2);
...
//조조1 손권2 전쟁
$query = "update diplomacy set state=1,term=45 where me=1 and you=2";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
$query = "update diplomacy set state=1,term=45 where you=1 and me=2";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
//조조1 유비4 전쟁
$query = "update diplomacy set state=1,term=45 where me=1 and you=4";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
$query = "update diplomacy set state=1,term=45 where you=1 and me=4";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
//손권2 유비4 불가침
$query = "update diplomacy set state=7,term=48 where me=2 and you=4";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
$query = "update diplomacy set state=7,term=48 where you=2 and me=4";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
//////////////////////////외교 끝//////////////////////////////////////////////////

//////////////////////////장수//////////////////////////////////////////////////
//국가1 조조  국가2 손권  국가3 유장  국가4 유비  국가5 마등
//국가6 장로  국가7 한현  국가8 조범  국가9 유도  국가10공손강 국가11 금선
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1012,  73,     "간옹",$img,1012,  4,    "-", 31, 33, 70, 0, 164, 225, "안전", "경작");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1017, 102,     "고간",$img,1017,  7,    "-", 60, 57, 51, 0, 168, 206, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1024,  53,     "고패",$img,1024,  3,    "-", 53, 56, 28, 0, 170, 212, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1025,  74,     "공도",$img,1025,  0,    "-", 26, 73, 19, 0, 164, 200, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1026, 142,   "공손강",$img,1026, 10,    "-", 64, 72, 61,12, 172, 210, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1034,  43,     "공융",$img,1034,  1,    "-", 63, 48, 85, 0, 153, 208, "왕좌", "경작");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1035,  35,     "공주",$img,1035,  0,    "-", 64, 35, 78, 0, 151, 194, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1036,  83,     "공지",$img,1036, 11,    "-", 57, 54, 64, 0, 178, 242, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1047,  76,     "관우",$img,1047,  4,    "-", 96, 98, 80, 0, 162, 219, "의협", "위압", "네놈들 모두 상대해주마!");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1050,  76,     "관평",$img,1050,  4,    "-", 77, 80, 70, 0, 186, 219, "의협", "보병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1059,  46,     "금선",$img,1059, 11,    "-", 55, 49, 36,12, 155, 208, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1065,  59,     "뇌동",$img,1065,  3,    "-", 70, 77, 45, 0, 172, 218, "출세", "궁병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1084,  66,     "동화",$img,1084,  3,    "-", 48, 64, 53, 0, 168, 219, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1093,  71,     "마대",$img,1093,  5,    "-", 77, 79, 49, 0, 183, 246, "대의", "기병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1094,  70,     "마등",$img,1094,  5,    "-", 80, 87, 56,12, 149, 211, "왕좌", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1097,  48,     "마완",$img,1097,  5,    "-", 49, 64, 26, 0, 170, 211, "안전", "기병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1098,  19,     "마준",$img,1098,  0,    "-", 45, 63, 62, 0, 196, 260, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1099,  71,     "마철",$img,1099,  5,    "-", 71, 60, 31, 0, 179, 211, "대의", "기병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1100,  70,     "마초",$img,1100,  5,    "-", 78, 97, 40, 0, 176, 226, "대의", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1103,  71,     "마휴",$img,1103,  5,    "-", 71, 60, 32, 0, 178, 211, "대의", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1118, 108,     "미방",$img,1118,  4,    "-", 58, 65, 37, 0, 169, 222, "패권", "징병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1119,  77,     "미축",$img,1119,  4,    "-", 26, 30, 65, 0, 165, 220, "왕좌", "상재");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1122,  65,     "방덕",$img,1122,  5,    "-", 76, 90, 67, 0, 170, 219, "의협", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1156,  76,     "서서",$img,1156,  1,    "-", 90, 70, 96, 0, 178, 232, "의협", "귀병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1164,  69,     "성의",$img,1164,  5,    "-", 45, 64, 22, 0, 168, 211, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1165, 129,     "소비",$img,1165,  2,    "-", 67, 63, 49, 0, 172, 221, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1166,  76,     "손건",$img,1166,  4,    "-", 42, 33, 73, 0, 165, 215, "대의", "거상");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1169, 125,     "손권",$img,1169,  2,    "-", 90, 77, 83,12, 182, 252, "할거", "수비", "선친께서 물려주신 이 땅을 내어줄 수는 없다.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1204,  14,     "양백",$img,1204,  6,    "-", 55, 54, 53, 0, 171, 214, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1207,  13,     "양송",$img,1207,  6,    "-", 15, 35, 34, 0, 167, 215, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1211,   9,    "양추1",$img,1211,  0,    "-", 51, 67, 16, 0, 159, 199, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1212,  31,     "양호",$img,1212,  0,    "-", 91, 69, 80, 0, 221, 278, "패권",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1213,  53,     "양회",$img,1213,  3,    "-", 60, 67, 40, 0, 167, 212, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1232,  18,     "염포",$img,1232,  6,    "-", 33, 35, 77, 0, 163, 231, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1235,  59,     "오란",$img,1235,  3,    "-", 67, 75, 42, 0, 170, 218, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1247,  57,     "왕루",$img,1247,  3,    "-", 40, 28, 76, 0, 173, 211, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1274,  81,     "위연",$img,1274,  7,    "-", 78, 94, 62, 0, 175, 234, "패권", "보병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1275,  96,     "위유",$img,1275,  0,    "-", 53, 69, 71, 0, 151, 193, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1276,  76,     "유기",$img,1276,  4,    "-", 57, 19, 73, 0, 174, 209, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1277,  36,     "유대",$img,1277,  0,    "-", 61, 57, 62, 0, 147, 202, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1278, 134,     "유도",$img,1278,  9,    "-", 35, 33, 68,12, 168, 214, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1279,  46,     "유벽",$img,1279,  0,    "-", 63, 71, 23, 0, 168, 210, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1280,  75,     "유봉",$img,1280,  4,    "-", 60, 65, 62, 0, 188, 220, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1281,  75,     "유비",$img,1281,  4,    "-", 85, 75, 70,12, 161, 223, "왕좌", "인덕", "그저 공명만 믿을 뿐이다.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1290,  55,     "유장",$img,1290,  3,    "-", 38, 31, 63,12, 162, 219, "할거", "수비");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1309,  77,     "이적",$img,1309,  4,    "-", 55, 27, 77, 0, 162, 226, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1319,  15,     "장로",$img,1319,  6,    "-", 76, 44, 80,12, 163, 237, "유지", "축성", "쌀 다섯말만 가져오시오. 다 낫게 해드리리다.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1322,  76,     "장비",$img,1322,  4,    "-", 79, 99, 48, 0, 167, 221, "의협", "무쌍", "다 죽여버리겠다! 으하하!");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1326,  72,     "장송",$img,1326,  3,    "-", 49, 28, 93, 0, 170, 212, "할거", "통찰");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1329,   8,     "장연",$img,1329,  1,    "-", 78, 66, 47, 0, 153, 210, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1333,  15,     "장위",$img,1333,  6,    "-", 65, 70, 29, 0, 172, 215, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1334,  36,     "장윤",$img,1334,  1,    "-", 67, 59, 60, 0, 163, 208, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1337,  56,     "장임",$img,1337,  3,    "-", 83, 82, 74, 0, 169, 214, "대의", "견고");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1347,  48,     "장횡",$img,1347,  5,    "-", 53, 67, 25, 0, 178, 211, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1366,  69,     "정은",$img,1366,  5,    "-", 53, 62, 26, 0, 169, 211, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1367, 121,   "제갈각",$img,1367,  0,    "-", 61, 53, 92, 0, 203, 253, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1368,  76,   "제갈균",$img,1368,  4,    "-", 59, 45, 74, 0, 185, 252, "안전", "상재");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1369, 121,   "제갈근",$img,1369,  2,    "-", 60, 42, 88, 0, 174, 241, "왕좌", "경작");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1370,  76,   "제갈량",$img,1370,  4,    "-", 97, 55,100, 0, 181, 234, "왕좌", "집중", "슬슬 움직여 보도록 하겠습니다.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1380,  83,     "조범",$img,1380,  8,    "-", 58, 40, 63,12, 168, 218, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1389,  76,     "조운",$img,1389,  4,    "-", 95, 98, 87, 0, 168, 229, "왕좌", "무쌍", "상산 조자룡이 여기있다! 모두 덤벼라!");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1392,  25,     "조조",$img,1392,  1,    "-",100, 80, 95,12, 155, 220, "패권", "반계", "음. 뭔가 불길하다.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1408, 126,     "주유",$img,1408,  2,    "-", 97, 73, 97, 0, 175, 210, "패권", "신산");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1412,  76,     "주창",$img,1412,  4,    "-", 42, 79, 30, 0, 164, 219, "의협", "궁병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1422,  72,     "진도",$img,1422,  4,    "-", 71, 85, 70, 0, 171, 237, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1428,  81,     "진식",$img,1428,  7,    "-", 47, 68, 52, 0, 191, 230, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1429,  79,     "진진",$img,1429,  4,    "-", 58, 38, 64, 0, 170, 235, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1434,  36,     "채모",$img,1434,  1,    "-", 79, 69, 68, 0, 155, 208, "정복", "궁병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1435,  36,     "채중",$img,1435,  1,    "-", 58, 43, 55, 0, 168, 208, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1436,  36,     "채화",$img,1436,  1,    "-", 56, 47, 49, 0, 166, 208, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1441, 124,   "태사자",$img,1441,  2,    "-", 71, 97, 65, 0, 166, 209, "대의", "무쌍");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1442, 124,   "태사향",$img,1442,  2,    "-", 51, 69, 50, 0, 189, 246, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1443,  12,     "포륭",$img,1443,  8,    "-", 53, 74, 20, 0, 174, 208, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1454,  26,   "하후은",$img,1454,  1,    "-", 49, 51, 39, 0, 180, 208, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1463,  48,     "한수",$img,1463,  5,    "-", 66, 76, 77, 0, 142, 215, "대의", "기병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1464,  40,     "한숭",$img,1464,  1,    "-", 21, 25, 70, 0, 154, 210, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1465,   7,     "한충",$img,1465,  0,    "-", 41, 66, 29, 0, 151, 185, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1466,   9,     "한현",$img,1466,  7,    "-", 43, 61, 20,12, 163, 208, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1475,  12,   "형도영",$img,1475,  9,    "-", 49, 78, 23, 0, 174, 208, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1476, 148,   "호거아",$img,1476,  0,    "-", 35, 76, 61, 0, 164, 206, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1477,  76,     "호반",$img,1477,  4,    "-", 61, 58, 46, 0, 179, 233, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1483,  10,     "화흠",$img,1483,  2,    "-", 18, 43, 75, 0, 157, 231, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1489,  72,     "황충",$img,1489,  7,    "-", 84, 94, 67, 0, 148, 222, "왕좌", "궁병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1509,  34,     "금의",$img,1509, 11,    "-", 18, 40, 63, 0, 177, 218,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1514,  42,     "누규",$img,1514,  1,    "-", 54, 19, 88, 0, 143, 212,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1531,  55,     "방희",$img,1531,  3,    "-", 59, 38, 69, 0, 153, 218,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1543,  36,   "성공영",$img,1543,  5,    "-", 73, 58, 80, 0, 172, 220,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1565,  16,     "양앙",$img,1565,  6,    "-", 65, 70, 39, 0, 172, 215,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1566,  17,     "양임",$img,1566,  6,    "-", 71, 78, 56, 0, 170, 215,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1569,  48,    "양추2",$img,1569,  5,    "-", 66, 67, 61, 0, 172, 238,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1575,  36,     "염행",$img,1575,  5,    "-", 70, 86, 38, 0, 159, 222,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1597,  55,     "유괴",$img,1597,  3,    "-", 75, 72, 66, 0, 165, 214,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1600,  29,     "유복",$img,1600,  1,    "-", 54, 50, 73, 0, 164, 208,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1608,  48,     "이감",$img,1608,  5,    "-", 59, 67, 33, 0, 176, 211,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1609,  19,     "이승",$img,1609,  0,    "-", 13, 26, 32, 0, 201, 249,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1610,  22,     "이통",$img,1610,  1,    "-", 75, 84, 52, 0, 168, 211,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1641,  36,     "주령",$img,1641,  0,    "-", 77, 70, 69, 0, 170, 236,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1648,  12,     "진응",$img,1648,  8,    "-", 62, 69, 49, 0, 172, 208,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1675,  48,     "후선",$img,1675,  5,    "-", 56, 66, 35, 0, 175, 228,    "-",    "-");
...
RegCity($connect, 1, "강릉");
RegCity($connect, 1, "장판");
...
RegCity($connect, 4, "강하", 1);
RegCity($connect, 5, "서량", 1);
RegCity($connect, 5, "천수");
RegCity($connect, 6, "한중", 1);
RegCity($connect, 6, "양평");
RegCity($connect, 7, "장사", 1);
RegCity($connect, 8, "계양", 1);
RegCity($connect, 9, "영릉", 1);
RegCity($connect, 10, "안평", 1);
RegCity($connect, 11, "무릉", 1);
...
//////////////////////////이벤트///////////////////////////////////////////////
$history[count($history)] = "<C>●</>207년 1월:<L><b>【역사모드7】</b>적벽대전</>";
$history[count($history)] = "<C>●</>207년 1월:<L><b>【이벤트】</b></><Y>하후돈</>을 패주시킨 <Y>서서</>는 계책에 빠져 <Y>조조</>에게 귀순합니다.";
$history[count($history)] = "<C>●</>207년 1월:<L><b>【이벤트】</b></><Y>서서</>의 천거로 <Y>유비</>는 <Y>제갈량</>을 삼고초려의 예로 영입합니다.";
