...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1002,   1,     "헌제",$img,1002,  1,    "-", 17, 13, 61, 0, 170, 250, "안전",    "-", "한 왕조는 이대로 끝나는 것인가...");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1011,  20,     "가후",$img,1011,  1,    "-", 69, 30, 94, 0, 147, 223, "할거", "귀병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1020, 144,     "고순",$img,1020,  1,    "-", 79, 82, 65, 0, 162, 198, "의협", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1026, 142,   "공손강",$img,1026, 19,    "-", 64, 72, 61, 0, 172, 210, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1027, 142,   "공손공",$img,1027, 19,    "-", 68, 41, 75, 0, 174, 238, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1028, 142,   "공손도",$img,1028, 19,    "-", 62, 72, 41,12, 154, 204, "정복", "기병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1029,  65,   "공손범",$img,1029,  9,    "-", 61, 67, 61, 0, 158, 199, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1030,  65,   "공손속",$img,1030,  9,    "-", 60, 76, 41, 0, 176, 199, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1031,  10,   "공손연",$img,1031,  0,    "-", 74, 79, 64, 0, 205, 238, "패권", "돌격");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1032,  65,   "공손월",$img,1032,  9,    "-", 47, 63, 46, 0, 160, 192, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1033,  65,   "공손찬",$img,1033,  9,    "-", 61, 87, 67,12, 152, 199, "패권", "기병", "나의 백마부대를 당할자 누구냐!");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1034,  43,     "공융",$img,1034, 17,    "-", 63, 48, 85,12, 153, 208, "왕좌", "경작");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1035,  35,     "공주",$img,1035, 20,    "-", 64, 35, 78,12, 151, 194, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1039,   2,     "곽사",$img,1039,  1,    "-", 58, 67, 31, 0, 146, 197, "패권",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1047,  76,     "관우",$img,1047, 16,    "-", 96, 98, 80, 0, 162, 219, "의협", "위압", "나 관우, 무예와 지식을 겸비하였소!");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1055,  98,     "교모",$img,1055, 13,    "-", 59, 58, 61, 0, 150, 191, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1056,  98,     "교현",$img,1056, 13,    "-", 50, 18, 60, 0, 158, 210, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1057,   6,   "구역거",$img,1057, 12,    "-", 51, 72, 49, 0, 152, 193, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1065,  59,     "뇌동",$img,1065,  5,    "-", 70, 77, 45, 0, 172, 218, "출세", "궁병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1069,  64,     "단경",$img,1069,  9,    "-", 68, 61, 68, 0, 156, 199, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1074,  82,     "도겸",$img,1074,  8,    "-", 51, 32, 61,12, 132, 194, "할거", "인덕");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1078,   2,     "동민",$img,1078,  1,    "-", 52, 65, 49, 0, 149, 192, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1079,  21,     "동소",$img,1079,  2,    "-", 46, 46, 62, 0, 156, 236, "패권",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1080, 127,     "동습",$img,1080,  0,    "-", 53, 64, 32, 0, 169, 215, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1081,  89,     "동승",$img,1081,  1,    "-", 75, 66, 65, 0, 154, 200, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1082,  78,     "동윤",$img,1082,  0,    "-", 64, 26, 78, 0, 192, 246, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1083,   2,     "동탁",$img,1083,  1,    "-", 87, 91, 54,12, 139, 192, "패권", "기병", "크하하. 드디어 천하를 손안에 넣었도다!");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1094,  70,     "마등",$img,1094, 10,    "-", 80, 87, 56,12, 149, 211, "왕좌", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1100,  70,     "마초",$img,1100, 10,    "-", 78, 97, 40, 0, 176, 226, "대의", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1111,  96,     "목순",$img,1111, 14,    "-", 17, 21, 68, 0, 157, 191, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1112,  43,   "무안국",$img,1112, 17,    "-", 51, 73, 18, 0, 156, 191, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1118, 108,     "미방",$img,1118,  8,    "-", 58, 65, 37, 0, 169, 222, "패권", "징병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1119,  77,     "미축",$img,1119,  8,    "-", 26, 30, 65, 0, 165, 220, "왕좌", "상재");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1120,  94,     "반봉",$img,1120, 11,    "-", 61, 75, 17, 0, 155, 191, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1127, 149,     "번주",$img,1127,  1,    "-", 67, 77, 21, 0, 149, 192, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1158, 142,     "서영",$img,1158,  1,    "-", 47, 63, 33, 0, 147, 191, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1164,  69,     "성의",$img,1164, 10,    "-", 45, 64, 22, 0, 168, 211, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1167, 125,     "손견",$img,1167,  7,    "-", 96, 95, 76,12, 156, 192, "왕좌", "무쌍", "강동의 호랑이. 손견 여기 있소!");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1178, 126,     "손정",$img,1178,  7,    "-", 59, 56, 62, 0, 160, 206, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1181, 125,     "손책",$img,1181,  7,    "-", 96, 96, 78, 0, 175, 200, "패권", "필살");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1188, 147,     "송헌",$img,1188,  1,    "-", 42, 63, 41, 0, 157, 200, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1195,  85,     "신평",$img,1195, 11,    "-", 68, 51, 75, 0, 165, 204, "왕좌",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1200,  23,     "악진",$img,1200,  4,    "-", 73, 67, 56, 0, 159, 218, "대의", "돌격");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1205,  92,    "양봉1",$img,1205,  1,    "-", 57, 64, 36, 0, 153, 197, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1206,  91,    "양봉2",$img,1206,  0,    "-", 62, 78, 61, 0, 191, 252, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1207,  13,     "양송",$img,1207, 15,    "-", 15, 35, 34, 0, 167, 215, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1211,   9,    "양추1",$img,1211, 14,    "-", 51, 67, 16, 0, 159, 199, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1215,   6,   "어부라",$img,1215, 14,    "-", 78, 80, 61, 0, 150, 195, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1216,  64,     "엄강",$img,1216,  9,    "-", 57, 65, 44, 0, 163, 192, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1229, 145,     "여포",$img,1229,  1,    "-", 74,100, 29, 0, 156, 198, "패권", "돌격", "내 앞을 막는 자는 모두 쓸어버리겠다.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1232,  18,     "염포",$img,1232, 15,    "-", 33, 35, 77, 0, 163, 231, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1235,  59,     "오란",$img,1235,  5,    "-", 67, 75, 42, 0, 170, 218, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1236,  72,     "오반",$img,1236,  0,    "-", 70, 66, 45, 0, 171, 234, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1246,  34,     "왕랑",$img,1246,  8,    "-", 49, 29, 51, 0, 162, 228, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1249,  86,     "왕수",$img,1249, 17,    "-", 34, 34, 67, 0, 168, 218, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1252,  92,     "왕윤",$img,1252,  1,    "-", 16, 18, 77, 0, 137, 192, "왕좌",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1268, 101,     "원소",$img,1268,  2,    "-", 85, 67, 76,12, 154, 202, "패권", "위압", "명문 집안 출신 나, 원소만이 천하를 잠잠케 하리라!");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1269, 140,     "원술",$img,1269,  6,    "-", 77, 59, 71,12, 155, 199, "패권", "축성", "흥, 관직도 없는 것들은 다 물럿거라~");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1273, 147,     "위속",$img,1273,  1,    "-", 57, 59, 41, 0, 156, 200, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1274,  81,     "위연",$img,1274,  0,    "-", 78, 94, 62, 0, 175, 234, "패권", "보병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1275,  96,     "위유",$img,1275, 12,    "-", 53, 69, 71, 0, 151, 193, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1276,  76,     "유기",$img,1276,  3,    "-", 57, 19, 73, 0, 174, 209, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1277,  36,     "유대",$img,1277, 13,    "-", 61, 57, 62,12, 147, 202, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1281,  75,     "유비",$img,1281, 16,    "-", 85, 75, 70,12, 161, 223, "왕좌", "인덕", "나도 이제 겨우 기반을 잡게 되는구나...");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1289,  96,     "유우",$img,1289, 12,    "-", 68, 34, 72,12, 145, 193, "왕좌",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1293,  45,    "유표1",$img,1293,  3,    "-", 71, 57, 71,12, 142, 208, "할거",    "-", "강하 팔준에서 제일가는 이 유표에게로 오시오!");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1304,   2,     "이각",$img,1304,  1,    "-", 56, 77, 43, 0, 148, 198, "패권",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1305, 146,     "이숙",$img,1305,  1,    "-", 27, 45, 67, 0, 156, 192, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1306,  71,     "이엄",$img,1306,  5,    "-", 80, 84, 81, 0, 172, 234, "패권",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1307,   2,     "이유",$img,1307,  1,    "-", 64, 22, 90, 0, 150, 192, "패권", "귀모");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1310,  22,     "이전",$img,1310,  4,    "-", 75, 68, 82, 0, 174, 216, "왕좌",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1319,  15,     "장로",$img,1319, 15,    "-", 76, 44, 80,12, 163, 237, "유지", "축성", "쌀 다섯말만 들고 오시오. 모두 고쳐드리리다.");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1320,  23,     "장료",$img,1320,  1,    "-", 89, 93, 83, 0, 169, 222, "의협", "견고");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1321,   7,     "장보",$img,1321,  0,    "-", 78, 81, 76, 0, 148, 185, "패권", "환술");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1322,  76,     "장비",$img,1322, 16,    "-", 79, 99, 48, 0, 167, 221, "의협", "무쌍", "이거 몸이 근질근질 하구만!");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1327, 148,     "장수",$img,1327,  1,    "-", 71, 72, 69, 0, 154, 207, "할거",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1328, 145,    "장양1",$img,1328, 14,    "-", 62, 66, 65,12, 150, 199, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1331, 118,     "장온",$img,1331,  1,    "-", 21, 30, 69, 0, 193, 231, "할거",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1332,  78,     "장완",$img,1332,  0,    "-", 70, 55, 86, 0, 188, 246, "할거", "상재");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1333,  15,     "장위",$img,1333, 15,    "-", 65, 70, 29, 0, 172, 215, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1337,  56,     "장임",$img,1337,  5,    "-", 83, 82, 74, 0, 169, 214, "대의", "견고");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1338, 148,    "장제1",$img,1338,  1,    "-", 70, 65, 59, 0, 144, 196, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1341,  17,     "장패",$img,1341,  8,    "-", 44, 78, 43, 0, 165, 231, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1344,  27,     "장합",$img,1344, 11,    "-", 83, 91, 63, 0, 167, 231, "출세", "궁병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1351,  96,     "저수",$img,1351, 11,    "-", 82, 54, 88, 0, 156, 201, "할거", "반계");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1357,  42,     "전주",$img,1357, 12,    "-", 69, 67, 51, 0, 169, 214, "의협",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1361, 126,     "정보",$img,1361,  7,    "-", 81, 64, 76, 0, 151, 216, "패권",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1366,  69,     "정은",$img,1366, 10,    "-", 53, 62, 26, 0, 169, 211, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1378, 127,     "조무",$img,1378,  7,    "-", 71, 68, 71, 0, 155, 191, "의협",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1383, 147,     "조성",$img,1383,  1,    "-", 44, 69, 51, 0, 163, 198, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1384,  26,     "조순",$img,1384,  4,    "-", 66, 57, 72, 0, 170, 210, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1385,  25,     "조식",$img,1385,  0,    "-", 19, 19, 90, 0, 192, 232, "왕좌", "귀모");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1386,  25,     "조앙",$img,1386,  4,    "-", 44, 65, 62, 0, 175, 197, "왕좌",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1389,  76,     "조운",$img,1389,  0,    "-", 95, 98, 87, 0, 168, 229, "왕좌", "무쌍");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1390,  25,     "조웅",$img,1390,  0,    "-", 59, 27, 44, 0, 194, 220, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1391,  26,     "조인",$img,1391,  4,    "-", 74, 79, 62, 0, 168, 223, "패권", "보병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1392,  25,     "조조",$img,1392,  4,    "-",100, 80, 95,12, 155, 220, "패권", "반계", "천하는 이제 힘있는 자의 몫이다...");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1396,  84,     "조표",$img,1396,  8,    "-", 34, 70, 16, 0, 151, 196, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1397,   7,    "조홍1",$img,1397,  0,    "-", 52, 66, 42, 0, 156, 185, "유지",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1398,  24,    "조홍2",$img,1398,  4,    "-", 72, 69, 44, 0, 169, 232, "패권",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1401,  26,     "조휴",$img,1401,  4,    "-", 75, 71, 70, 0, 174, 228, "패권",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1413, 126,     "주치",$img,1413,  7,    "-", 58, 55, 56, 0, 156, 224, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1419,  28,     "진군",$img,1419,  8,    "-", 60, 38, 87, 0, 167, 235, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1420, 143,     "진궁",$img,1420,  4,    "-", 77, 51, 90, 0, 154, 198, "할거", "신중");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1421,  79,     "진규",$img,1421,  8,    "-", 22, 19, 71, 0, 132, 206, "할거",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1422,  72,     "진도",$img,1422,  0,    "-", 71, 85, 70, 0, 171, 237, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1423,  79,     "진등",$img,1423,  8,    "-", 64, 62, 71, 0, 169, 207, "할거",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1441, 124,   "태사자",$img,1441, 17,    "-", 71, 97, 65, 0, 166, 209, "대의", "무쌍");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1449,  26,   "하후돈",$img,1449,  4,    "-", 88, 92, 71, 0, 156, 220, "의협", "돌격");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1452,  26,   "하후연",$img,1452,  4,    "-", 79, 90, 58, 0, 162, 219, "패권", "궁병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1460, 126,     "한당",$img,1460,  7,    "-", 68, 67, 64, 0, 156, 225, "할거",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1461,  93,     "한복",$img,1461, 11,    "-", 66, 59, 42,12, 149, 191, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1462,   8,     "한섬",$img,1462,  0,    "-", 39, 62, 35, 0, 159, 196, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1463,  48,     "한수",$img,1463, 10,    "-", 66, 76, 77, 0, 142, 215, "대의", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1474,  87,     "허정",$img,1474, 20,    "-", 18, 29, 74, 0, 152, 222, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1475,  12,   "형도영",$img,1475,  0,    "-", 49, 78, 23, 0, 174, 208, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1476, 148,   "호거아",$img,1476,  1,    "-", 35, 76, 61, 0, 164, 206, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1481,   2,     "화웅",$img,1481,  1,    "-", 68, 88, 24, 0, 155, 191, "출세", "돌격");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1485, 127,     "황개",$img,1485,  7,    "-", 78, 85, 69, 0, 154, 218, "왕좌", "징병");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1486,  56,     "황권",$img,1486,  0,    "-", 76, 46, 77, 0, 167, 240, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1487,  41,     "황란",$img,1487,  0,    "-", 29, 70, 25, 0, 200, 264, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1488,  88,   "황보숭",$img,1488,  1,    "-", 83, 63, 73, 0, 132, 195, "왕좌",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1491, 147,     "후성",$img,1491,  1,    "-", 56, 62, 33, 0, 158, 199, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1502,  65,     "관정",$img,1502,  9,    "-", 35, 50, 73, 0, 158, 199,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1508,  99,     "국의",$img,1508,  2,    "-", 83, 79, 50, 0, 146, 191,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1514,  42,     "누규",$img,1514,  3,    "-", 54, 19, 88, 0, 143, 212,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1531,  55,     "방희",$img,1531,  5,    "-", 59, 38, 69, 0, 153, 218,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1554,  85,     "순심",$img,1554, 11,    "-", 20, 21, 79, 0, 164, 208,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1575,  36,     "염행",$img,1575, 10,    "-", 70, 86, 38, 0, 159, 222,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1578, 126,     "오경",$img,1578,  7,    "-", 73, 60, 57, 0, 159, 203,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1586,  63,     "왕문",$img,1586,  9,    "-", 64, 67, 32, 0, 162, 205,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1591,   1,     "우보",$img,1591,  1,    "-", 43, 63, 12, 0, 159, 192,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1594,  95,     "원유",$img,1594, 13,    "-", 57, 38, 73, 0, 150, 193,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1602, 139,     "유섭",$img,1602,  6,    "-", 62, 79, 26, 0, 158, 190,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1631,  75,     "전예",$img,1631,  9,    "-", 80, 62, 83, 0, 171, 252,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1632,  64,     "전해",$img,1632,  9,    "-", 71, 63, 57, 0, 154, 199,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1641,  36,     "주령",$img,1641,  2,    "-", 77, 70, 69, 0, 170, 236,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1653,  65,     "추단",$img,1653,  9,    "-", 63, 71, 36, 0, 148, 193,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1657,  22,     "포신",$img,1657, 13,    "-", 78, 60, 83, 0, 152, 192,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1668, 149,     "호진",$img,1668,  1,    "-", 65, 77, 13, 0, 146, 190,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1669,  29,     "호질",$img,1669,  0,    "-", 73, 50, 75, 0, 192, 250,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1670,   7,     "환계",$img,1670,  7,    "-", 12, 25, 67, 0, 156, 221,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1676,   8,     "휴고",$img,1676, 18,    "-", 61, 72, 40, 0, 151, 199,    "-",    "-");
