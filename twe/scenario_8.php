...
//////////////////////////국가1/////////////////////////////////////////////////
RegNation($connect, "조조", "000080", 10000, 10000, "강남 정벌에 실패한 뒤 한중을 노리는 조조", 1000, 78, "병가", 6);
//////////////////////////국가2/////////////////////////////////////////////////
RegNation($connect, "손권", "FF0000", 10000, 10000, "적벽대전을 대승으로 이끈 뒤 세력을 재정비하는 손권", 1000, 49, "덕가", 4);
//////////////////////////국가3////////////////////////////////////////////////
RegNation($connect, "유비", "008000", 10000, 10000, "형주를 제패하고 익주를 노리는 유비", 1000, 43, "유가", 4);
//////////////////////////국가4/////////////////////////////////////////////////
RegNation($connect, "유장", "483D8B", 10000, 10000, "장로를 막기 위해 유비를 끌어들인 유장", 1000, 24, "유가", 4);
//////////////////////////국가5/////////////////////////////////////////////////
RegNation($connect, "장로", "20B2AA", 10000, 10000, "익주 진출에 실패하고 조조에게 위협받는 장로", 1000, 7, "오두미도", 2);
//////////////////////////국가6/////////////////////////////////////////////////
RegNation($connect, "마초", "808000", 10000, 10000, "서북지방을 잃고 장로에게 의탁중인 마초", 1000, 3, "병가", 0);
//////////////////////////국가7/////////////////////////////////////////////////
RegNation($connect, "공손공", "A0522D", 10000, 10000, "공손공", 1000, 1, "도적", 1);
...
//조조1 장로5 전쟁
$query = "update diplomacy set state=1,term=60 where me=1 and you=5";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
$query = "update diplomacy set state=1,term=60 where you=1 and me=5";
MYDB_query($query, $connect) or Error(__LINE__.MYDB_error($connect),"");
//유비3 유장4 전쟁
...
//////////////////////////장수//////////////////////////////////////////////////
//국가1 조조  국가2 손권  국가3 유비  국가4 유장  국가5 장로
//국가6 마초  국가7 공손공
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1002,   1,     "헌제",$img,1002,  1,    "-", 17, 13, 61, 0, 170, 250, "안전",    "-", "...");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1027, 142,   "공손공",$img,1027,  7,    "-", 68, 41, 75,12, 174, 238, "정복",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1042,  67,     "곽준",$img,1042,  3,    "-", 76, 69, 73, 0, 178, 217, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1054,  40,     "괴월",$img,1054,  1,    "-", 26, 30, 84, 0, 157, 214, "유지", "귀병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1063, 124,    "노숙1",$img,1063,  2,    "-", 90, 42, 94, 0, 172, 217, "왕좌", "상재");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1080, 127,     "동습",$img,1080,  2,    "-", 53, 64, 32, 0, 169, 215, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1084,  66,     "동화",$img,1084,  4,    "-", 48, 64, 53, 0, 168, 219, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1089,  73,     "등지",$img,1089,  4,    "-", 74, 51, 80, 0, 182, 251, "할거", "경작");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1090,  41,     "등충",$img,1090,  0,    "-", 60, 82, 55, 0, 230, 264, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1091,  54,     "등현",$img,1091,  4,    "-", 65, 59, 61, 0, 188, 248, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1092,  29,     "마균",$img,1092,  0,    "-", 33, 38, 80, 0, 200, 259, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1093,  71,     "마대",$img,1093,  6,    "-", 77, 79, 49, 0, 183, 246, "대의", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1100,  70,     "마초",$img,1100,  6,    "-", 78, 97, 40,12, 176, 226, "대의", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1123,  73,     "방통",$img,1123,  3,    "-", 86, 41, 97, 0, 179, 214, "패권", "반계", "신 방사원. 최선을 다하겠나이다.");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1137,  66,     "비시",$img,1137,  4,    "-", 18, 36, 61, 0, 176, 240, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1138, 141,     "비연",$img,1138,  0,    "-", 66, 65, 53, 0, 196, 238, "출세",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1139,  77,     "비위",$img,1139,  4,    "-", 72, 26, 73, 0, 193, 253, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1166,  76,     "손건",$img,1166,  3,    "-", 42, 33, 73, 0, 165, 215, "대의", "거상");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1176, 126,     "손유",$img,1176,  2,    "-", 77, 60, 67, 0, 177, 215, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1177, 122,     "손이",$img,1177,  0,    "-", 57, 62, 57, 0, 223, 272, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1178, 126,     "손정",$img,1178,  2,    "-", 59, 56, 62, 0, 160, 206, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1204,  14,     "양백",$img,1204,  5,    "-", 55, 54, 53, 0, 171, 214, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1207,  13,     "양송",$img,1207,  5,    "-", 15, 35, 34, 0, 167, 215, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1208,  43,     "양수",$img,1208,  1,    "-", 18, 31, 91, 0, 175, 219, "재간", "귀병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1232,  18,     "염포",$img,1232,  5,    "-", 33, 35, 77, 0, 163, 231, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1248,  76,     "왕보",$img,1248,  4,    "-", 47, 34, 75, 0, 171, 219, "대의",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1249,  86,     "왕수",$img,1249,  1,    "-", 34, 34, 67, 0, 168, 218, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1255,  30,     "왕찬",$img,1255,  1,    "-", 28, 28, 78, 0, 177, 217, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1256,  33,     "왕창",$img,1256,  0,    "-", 74, 57, 52, 0, 188, 259, "정복",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1257,  69,     "왕평",$img,1257,  1,    "-", 77, 76, 71, 0, 192, 248, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1263,  27,    "우금2",$img,1263,  1,    "-", 63, 77, 37, 0, 173, 226, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1278, 134,     "유도",$img,1278,  3,    "-", 35, 33, 68, 0, 168, 214, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1290,  55,     "유장",$img,1290,  4,    "-", 38, 31, 63,12, 162, 219, "할거", "수비");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1291,  45,     "유종",$img,1291,  0,    "-", 22, 26, 61, 0, 191, 208, "할거",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1292,  56,     "유파",$img,1292,  4,    "-", 47, 32, 70, 0, 186, 222, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1298, 121,     "육적",$img,1298,  2,    "-", 44, 29, 73, 0, 187, 219, "안전",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1317, 122,     "장굉",$img,1317,  2,    "-", 25, 21, 85, 0, 153, 212, "왕좌",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1318,   7,     "장량",$img,1318,  0,    "-", 68, 81, 68, 0, 153, 185, "정복", "환술");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1319,  15,     "장로",$img,1319,  5,    "-", 76, 44, 80,12, 163, 237, "유지", "축성");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1333,  15,     "장위",$img,1333,  5,    "-", 65, 70, 29, 0, 172, 215, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1336,  68,     "장익",$img,1336,  4,    "-", 75, 68, 63, 0, 188, 264, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1348, 141,     "장훈",$img,1348,  1,    "-", 67, 61, 60, 0, 156, 206, "안전",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1349, 120,     "장휴",$img,1349,  0,    "-", 42, 35, 70, 0, 204, 244, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1350, 126,     "장흠",$img,1350,  2,    "-", 64, 66, 67, 0, 168, 219, "대의", "저격");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1361, 126,     "정보",$img,1361,  2,    "-", 81, 64, 76, 0, 151, 216, "패권",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1380,  83,     "조범",$img,1380,  3,    "-", 58, 40, 63, 0, 168, 218, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1425, 124,     "진무",$img,1425,  2,    "-", 62, 74, 59, 0, 176, 215, "재간",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1426,  66,     "진복",$img,1426,  4,    "-", 36, 27, 76, 0, 160, 226, "재간",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1438,  20,     "최염",$img,1438,  1,    "-", 43, 54, 67, 0, 162, 216, "대의",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1448,  24,   "하후덕",$img,1448,  1,    "-", 67, 64, 39, 0, 178, 218, "출세",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1463,  48,     "한수",$img,1463,  1,    "-", 66, 76, 77, 0, 142, 215, "대의", "기병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1467,  27,     "한호",$img,1467,  1,    "-", 60, 73, 45, 0, 164, 218, "유지",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1485, 127,     "황개",$img,1485,  2,    "-", 78, 85, 69, 0, 154, 218, "왕좌", "징병");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1543,  36,   "성공영",$img,1543,  6,    "-", 73, 58, 80, 0, 172, 220,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1546,  46,     "소유",$img,1546,  1,    "-", 51, 61, 48, 0, 164, 210,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1553, 123,     "송겸",$img,1553,  2,    "-", 61, 48, 44, 0, 175, 215,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1565,  16,     "양앙",$img,1565,  5,    "-", 65, 70, 39, 0, 172, 215,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1566,  17,     "양임",$img,1566,  5,    "-", 71, 78, 56, 0, 170, 215,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1569,  48,    "양추2",$img,1569,  6,    "-", 66, 67, 61, 0, 172, 238,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1575,  36,     "염행",$img,1575,  6,    "-", 70, 86, 38, 0, 159, 222,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1605, 129,     "유찬",$img,1605,  2,    "-", 74, 75, 66, 0, 172, 255,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1606, 129,     "유평",$img,1606,  0,    "-", 65, 70, 67, 0, 218, 272,    "-",    "-");
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1607, 138,     "유훈",$img,1607,  1,    "-", 51, 64, 50, 0, 163, 216,    "-",    "-");
...
RegGeneral($connect,1,0,$fiction,$turnterm,$startyear,$year,1675,  48,     "후선",$img,1675,  6,    "-", 56, 66, 35, 0, 175, 228,    "-",    "-");
...
RegCity($connect, 4, "영안");
RegCity($connect, 4, "강주");
RegCity($connect, 5, "한중", 1);
RegCity($connect, 5, "양평");
RegCity($connect, 7, "안평", 1);
...
//////////////////////////이벤트///////////////////////////////////////////////
$history[count($history)] = "<C>●</>213년 1월:<L><b>【역사모드8】</b>익주 공방전</>";
$history[count($history)] = "<C>●</>213년 1월:<L><b>【이벤트】</b></><Y>마등</>을 섬멸시킨 <Y>조조</>는 <G><b>익주</b></>로 눈을 돌립니다.";
$history[count($history)] = "<C>●</>213년 1월:<L><b>【이벤트】</b></>도망친 <Y>마초</>는 <G><b>한중</b></>의 <Y>장로</>에게 의지합니다.";
