...
class DyingMessage{
    ...
    protected static function getUtilNPCMessageList():array{
        return [
            '<Y>;name;</>;이; 푸대접에 실망하여 <R>떠났습니다</>.',
            '<Y>;name;</>;이; 갑자기 화를 내며<R> 떠났습니다</>.',
            '<Y>;name;</>;이; 의견차이를 좁히지 못하고 <R>떠났습니다</>.',
            '<Y>;name;</>;이; 판단 착오였다며 <R>떠났습니다</>.',
            '<Y>;name;</>;이; 생활고가 나아지지 않는다며 <R>떠났습니다</>.',
            '<Y>;name;</>;이; 기대가 너무 컸다며 <R>떠났습니다</>.',
            '<Y>;name;</>;이; 아무 이유 없이 <R>떠났습니다</>.',
            '<Y>;name;</>;이; 자기 목적은 달성했다며 <R>떠났습니다</>.',
            '<Y>;name;</>;이; 자기가 없어도 될것 같다며 <R>떠났습니다</>.',
            '<Y>;name;</>;이; 처자식이 그립다며 <R>떠났습니다</>.',
        ];
    }
    ...
    function __construct(General $general)
    {
        ...
        if($general->getVar('owner') > 0 && $general->getVar('age') - $general->getVar('startage') > 1){
