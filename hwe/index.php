...
<table class="tb_layout bg0">
    ...
    <tr>
        <td width=498 id="generalPublicRecord" style="text-align:left;"><?=getGeneralPublicRecordRecent(15)?></td>
        <td width=498 id="generalLoc" style="text-align:left;"><?=getGenLogRecent($me['no'], 15)?></td>
    </tr>
    <tr><td width=998 colspan=2 class='bg1 center'><b>중원 정세</b></td></tr>
    <tr><td width=998 id="worldHistory" colspan=2 style="text-align:left;"><?=getWorldHistoryRecent(15)?></td></tr>
</table>
